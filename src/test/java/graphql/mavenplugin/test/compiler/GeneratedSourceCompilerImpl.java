...
public class GeneratedSourceCompilerImpl implements GeneratedSourceCompiler {
	 ...
	 */
	public GeneratedSourceCompilerImpl(Log log, String className, File javaSrcFolder, File classTargetFolder,
	 ...
	 */
	boolean compileJavaFiles(List<File> javaFiles) throws MojoExecutionException {
		...
		try {
			...
			throw new MojoExecutionException("Error after generating the java source file", e);
		}
	 ...
	 * @throws MojoExecutionException
	 */
	private File storeJavaSource(String javaSource) throws MojoExecutionException {
		...
		try {
			...
			throw new MojoExecutionException("Could generate the java source file", e);
		} finally {
			try {
				if (fos != null) {
					fos.close();
	 ...
	 * @throws MojoExecutionException
	 */
	File getClassFile() throws MojoExecutionException {
