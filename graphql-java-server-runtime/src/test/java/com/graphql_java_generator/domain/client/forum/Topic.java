...
public class Topic {
	...
	@GraphQLInputParameters(names = { "memberId", "memberName", "since" }, types = { "ID", "String",
			"Date" }, mandatories = { false, false,
					true }, listDepths = { 0, 0, 0 }, itemsMandatory = { false, false, false })
	...
	public String toString() {
		return "Topic {" + "id: " + id + ", " + "date: " + date + ", " + "author: " + author + ", "
				...
				+ ", " + "content: " + content + ", " + "posts: " + posts + ", " + "__typename: " + __typename + "}";
	}
