...
public enum CodeTemplate {
	...
	/**
	 * Creates a new {@code CodeTemplate} instance.
	 *
	 * @param scope
	 *            The scope for this template
	 * @param defaultPath
	 *            The default value to use
	 */
	private CodeTemplate(final CodeTemplateScope scope, final String defaultPath) {
		if (scope == null) {
			throw new java.lang.NullPointerException("scope is marked non-null but is null");
		}
		if (defaultPath == null) {
			throw new java.lang.NullPointerException("defaultPath is marked non-null but is null");
		}
		this.scope = scope;
