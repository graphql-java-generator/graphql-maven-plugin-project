 ...
 */
@Component
public class ${object.classSimpleName}Executor  implements GraphQLSubscriptionExecutor {
...
#end 
		return graphQLConfiguration${springBeanSuffix}.getQueryExecutor().execute(objectResponse, parameters,#if($field.fieldTypeAST.listDepth>0) (SubscriptionCallback<List>) (Object)#end subscriptionCallback, ${object.classSimpleName}.class, #if($field.fieldTypeAST.listDepth>0)List#else${field.type.classSimpleName}#end.class);
	}
