 ...
 */
@Component
public class BatchLoaderDelegate${batchLoader.type.classSimpleName}Impl implements BatchLoaderDelegate#if($configuration.generateBatchLoaderEnvironment)WithContext#end<${batchLoader.type.identifier.type.classSimpleName}, ${batchLoader.type.classSimpleName}> {
	 ...
	 */
	@Override
	public CompletionStage<List<${batchLoader.type.classSimpleName}>> load(List<${batchLoader.type.identifier.type.classSimpleName}> keys#if($configuration.generateBatchLoaderEnvironment), BatchLoaderEnvironment environment#end) {
