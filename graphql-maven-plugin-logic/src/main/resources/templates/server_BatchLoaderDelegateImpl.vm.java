 ...
 */
@Component
public class BatchLoaderDelegate${batchLoader.type.classSimpleName}Impl implements BatchLoaderDelegate<${batchLoader.type.identifier.type.classSimpleName}, ${batchLoader.type.classSimpleName}> {
