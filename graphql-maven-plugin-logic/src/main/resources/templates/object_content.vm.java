...
## (see issue #15 in the Gradle project for a sample of this)
	...
	public void set$fieldPrefixForGetterAndSetter${field.pascalCaseName}($type ${field.javaName}) {
		...
		} else if (${field.javaName} instanceof ${field.javaTypeFullClassname}) {
...
#foreach ($field in $object.fields)
				+ "${field.javaName}: " + this.${field.javaName}#if($foreach.hasNext) + ", "#end //$NON-NLS-1$#if($foreach.hasNext) //$NON-NLS-2$#end 
#end
        		+ "}"; //$NON-NLS-1$
    }
