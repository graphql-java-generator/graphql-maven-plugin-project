...
public class ${object.classSimpleName}Executor {
	...
	public ${object.classSimpleName}#if(${configuration.generateDeprecatedRequestResponse})Response#end execWithBindValues(ObjectResponse objectResponse, Map<String, Object> parameters)
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, ${object.classSimpleName}#if(${configuration.generateDeprecatedRequestResponse})Response#end.class);
	}
...
#foreach ($inputParameter in $field.inputParameters)
		...
		${configuration.packageName}.${field.owningType.classSimpleName} ret 
			= configuration.getQueryExecutor().execute(objectResponse, parameters, #if(${configuration.separateUtilityClasses})${configuration.packageName}.#end${field.owningType.classSimpleName}.class);
#else
