...
public class AllGraphQLCases_ServerPojo_SpringConfiguration extends AbstractSpringConfiguration {
	...
	static {
		...
		customScalars
				.add(new CustomScalarDefinition("Long", "java.lang.Long", null, "graphql.scalars.ExtendedScalars.GraphQLLong", null));
