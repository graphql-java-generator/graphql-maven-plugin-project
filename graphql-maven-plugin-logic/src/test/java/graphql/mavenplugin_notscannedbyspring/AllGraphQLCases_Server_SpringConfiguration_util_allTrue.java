...
public class AllGraphQLCases_Server_SpringConfiguration_util_allTrue extends AbstractSpringConfiguration {
	...
	static {
		...
		customScalars.add(new CustomScalarDefinition("JSON", "tools.jackson.databind.node.ObjectNode", null,
	...
	protected void addSpecificConfigurationParameterValue(GraphQLConfigurationTestHelper configuration) {
		...
		configuration.generateBatchLoaderEnvironment = true;// false tesTed in AllGraphQLCasesServer_util_allFalse_Test
		configuration.generateBatchMappingDataFetchers = false;// true is tested in
		// AllGraphQLCasesServer_util_batchMapping_Test
		configuration.generateDataFetcherForEveryFieldsWithArguments = true;// false tested in
																			// AllGraphQLCasesServer_util_allFalse_Test
		configuration.generateDataLoaderForLists = true;// false tesTed in AllGraphQLCasesServer_util_allFalse_Test
		configuration.generateJPAAnnotation = true;// false tesTed in AllGraphQLCasesServer_util_allFalse_Test
