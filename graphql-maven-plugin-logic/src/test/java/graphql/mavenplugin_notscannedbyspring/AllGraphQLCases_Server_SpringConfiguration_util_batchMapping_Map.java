...
public class AllGraphQLCases_Server_SpringConfiguration_util_batchMapping_Map
	...
	protected void addSpecificConfigurationParameterValue(GraphQLConfigurationTestHelper configuration) {
		...
		configuration.batchMappingDataFetcherReturnType = BatchMappingDataFetcherReturnType.MAP;
	}
}
