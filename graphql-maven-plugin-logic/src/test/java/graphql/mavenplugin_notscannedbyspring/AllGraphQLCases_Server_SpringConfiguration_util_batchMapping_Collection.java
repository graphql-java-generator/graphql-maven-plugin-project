...
public class AllGraphQLCases_Server_SpringConfiguration_util_batchMapping_Collection
	...
	protected void addSpecificConfigurationParameterValue(GraphQLConfigurationTestHelper configuration) {
		...
		configuration.batchMappingDataFetcherReturnType = BatchMappingDataFetcherReturnType.COLLECTION;
	}
}
