...
* Implement also Subscriptions. Currently queries and mutationsare managed.
...
* Manage field parameters. Currently, GraphQL Java Generator accepts parameters at the query/mutation level only, but not for field on regular object.
