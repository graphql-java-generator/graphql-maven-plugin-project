...
public class GraphQLController {
    ...
    @RequestMapping(value = "${graphql.url:graphql}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE,
            // The filter below insure that this mapping is not used when opening a WebSocket, that is: not used
            // when the request is for a subscription.
            // For subscription, a WebSocket should be created. And this is done with a WebSocketConfig spring bean, not
            // with a RestController like this one.
