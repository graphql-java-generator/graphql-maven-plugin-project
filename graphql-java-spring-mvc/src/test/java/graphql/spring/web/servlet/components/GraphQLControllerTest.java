...
public class GraphQLControllerTest {
	...
	public void testPostRequest() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc
				.perform(post("/graphql").content(toJson(request)).contentType(MediaType.APPLICATION_JSON))
		...
		this.mockMvc.perform(asyncDispatch(mvcResult)).andDo(print()).andExpect(status().isOk())
				.andExpect(content().contentType(MediaType.APPLICATION_JSON)).andExpect(jsonPath("data", is("bar")))
				.andReturn();
	...
	public void testQueryParamPostRequest() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc.perform(post("/graphql").param("query", query)
				.param("variables", variablesJson).param("operationName", operationName)).andExpect(status().isOk())
	...
	public void testSimpleQueryParamPostRequest() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc.perform(post("/graphql").param("query", query)).andExpect(status().isOk())
				.andExpect(request().asyncStarted()).andReturn();
	...
	public void testApplicationGraphqlPostRequest() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc.perform(post("/graphql").content(query).contentType("application/graphql"))
				.andExpect(status().isOk()).andExpect(request().asyncStarted()).andReturn();
	...
	public void testGetRequest() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc.perform(get("/graphql").param("query", query)
				.param("variables", variablesJson).param("operationName", operationName)).andExpect(status().isOk())
				.andExpect(request().asyncStarted()).andReturn();
	...
	public void testSimpleGetRequest() throws Exception {
		...
		MvcResult mvcResult = this.mockMvc.perform(get("/graphql").param("query", query)).andExpect(status().isOk())
				.andExpect(request().asyncStarted()).andReturn();
