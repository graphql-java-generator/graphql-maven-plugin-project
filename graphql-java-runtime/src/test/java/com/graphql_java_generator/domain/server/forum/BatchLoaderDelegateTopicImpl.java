 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Topic>> friends(DataFetchingEnvironment environment, DataLoader<java.lang.String, Topic> dataLoader,
 * 		Topic source) {
 ...
 */
@Component
public class BatchLoaderDelegateTopicImpl implements BatchLoaderDelegate<String, Topic> {
	 ...
	 */
	@Override
	public CompletionStage<List<Topic>> load(List<String> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateTopic.batchLoader(keys));
	}
