...
/**
 * This class is deprecated. Please use the MutationType instead.<BR/>
 ...
 * 
 * @author etienne-sf
 * @deprecated Please use the {@link MutationType} class instead.
 */
@Deprecated
@GraphQLQuery(name = "MutationType", type = RequestType.mutation)
@GraphQLObjectType("MutationType")
public class MutationTypeResponse extends MutationType {
