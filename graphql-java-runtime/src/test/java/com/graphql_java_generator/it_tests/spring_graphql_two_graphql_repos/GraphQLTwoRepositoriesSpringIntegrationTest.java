...
public class GraphQLTwoRepositoriesSpringIntegrationTest {
	...
	@EnableGraphQLRepositories({ "com.graphql_java_generator.client.graphqlrepository.spring_graphql_two_repos" })
	public static class SpringConfigTwoServers {

	}

	@Autowired
	GraphQLTwoRepositoriesTestCase graphQLRepository;
	...
	void testInvoke_partialRequest_noRequestName_withObjectArray() throws GraphQLRequestExecutionException,
		...
		assertEquals("{appearsIn name}", //
				GraphQLRepositoryTestHelper.getRegisteredGraphQLRequest(invocationHandler,
						GraphQLTwoRepositoriesTestCase.class, "withOneOptionalParam", CharacterInput.class));
	}
