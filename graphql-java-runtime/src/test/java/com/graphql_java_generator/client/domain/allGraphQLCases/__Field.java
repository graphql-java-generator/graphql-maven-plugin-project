...
public class __Field {
	...
	public String toString() {
		return "__Field {" + "name: " + name + ", " + "description: " + description + ", " + "args: " + args + ", "
				+ "type: " + type + ", " + "isDeprecated: " + isDeprecated + ", " + "deprecationReason: "
				+ deprecationReason + ", " + "__typename: " + __typename + "}";
	}
	...
	public static enum Field implements GraphQLField {
		Name("name"), Description("description"), Args("args"), Type("type"), IsDeprecated(
				"isDeprecated"), DeprecationReason("deprecationReason"), __typename("__typename");
