...
/**
 * This class contains the methods that allows the execution of the queries or mutations that are defined in the QueryType of the GraphQL schema.<BR/>
...
public class QueryTypeExecutor implements GraphQLQueryExecutor {
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Character c = myQyeryType.heroWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", episode, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
 ...
 @GraphQLNonScalar (fieldName = "hero", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * 
	 * <PRE>
	 * Character c = myQyeryType.hero("{id name @skip(if: false) appearsIn friends {id name}}", episode, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "hero", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character hero(String queryResponseDef, Episode episode, Object... paramsAndValues)
		...
		logger.debug("Executing query 'hero': {} ", queryResponseDef);
		ObjectResponse objectResponse = getHeroResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return heroWithBindValues(objectResponse, episode, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
 ...
 @GraphQLNonScalar (fieldName = "hero", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the hero query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getHeroResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "hero", RequestType.query
			, InputParameter.newBindParameter("episode","queryTypeHeroEpisode", InputParameterType.OPTIONAL, "Episode", false, 0, false)
			);
	}
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * List<Character> c = myQyeryType.charactersWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", episode, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "characters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * 
	 * <PRE>
	 * List<Character> c = myQyeryType.characters("{id name @skip(if: false) appearsIn friends {id name}}", episode, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "characters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public List<Character> characters(String queryResponseDef, Episode episode, Object... paramsAndValues)
		...
		logger.debug("Executing query 'characters': {} ", queryResponseDef);
		ObjectResponse objectResponse = getCharactersResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return charactersWithBindValues(objectResponse, episode, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
 ...
 @GraphQLNonScalar (fieldName = "characters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the characters query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getCharactersResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "characters", RequestType.query
			, InputParameter.newBindParameter("episode","queryTypeCharactersEpisode", InputParameterType.OPTIONAL, "Episode", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "human", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public Human human(String queryResponseDef, String id, Object... paramsAndValues)
		...
		logger.debug("Executing query 'human': {} ", queryResponseDef);
		ObjectResponse objectResponse = getHumanResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return humanWithBindValues(objectResponse, id, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
 ...
 @GraphQLNonScalar (fieldName = "human", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	...
	public com.graphql_java_generator.client.request.Builder getHumanResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "human", RequestType.query
			, InputParameter.newBindParameter("id","queryTypeHumanId", InputParameterType.OPTIONAL, "ID", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "droid", graphQLTypeSimpleName = "Droid", javaClass = Droid.class)
	public Droid droid(String queryResponseDef, String id, Object... paramsAndValues)
		...
		logger.debug("Executing query 'droid': {} ", queryResponseDef);
		ObjectResponse objectResponse = getDroidResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return droidWithBindValues(objectResponse, id, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
 ...
 @GraphQLNonScalar (fieldName = "droid", graphQLTypeSimpleName = "Droid", javaClass = Droid.class)
	...
	public com.graphql_java_generator.client.request.Builder getDroidResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "droid", RequestType.query
			, InputParameter.newBindParameter("id","queryTypeDroidId", InputParameterType.MANDATORY, "ID", true, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "__schema", graphQLTypeSimpleName = "__Schema", javaClass = __Schema.class)
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param name Parameter for the __type field of QueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLNonScalar (fieldName = "__type", graphQLTypeSimpleName = "__Type", javaClass = __Type.class)
	...
	public com.graphql_java_generator.client.request.Builder get__typeResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "__type", RequestType.query
			, InputParameter.newBindParameter("name","queryType__typeName", InputParameterType.MANDATORY, "String", true, 0, false)
			);
	}
