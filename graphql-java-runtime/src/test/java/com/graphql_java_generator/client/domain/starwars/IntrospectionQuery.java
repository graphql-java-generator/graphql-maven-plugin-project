...
public class IntrospectionQuery {
	...
	public __Schema __schemaWithBindValues(ObjectResponse objectResponse, Map<String, Object> parameters)
		...
		IntrospectionQuery__schema ret = executor.execute("query", objectResponse, parameters,
				IntrospectionQuery__schema.class);
	...
	public __Schema __schema(ObjectResponse objectResponse, Object... paramsAndValues)
		...
		IntrospectionQuery__schema ret = executor.execute("query", objectResponse, bindVariableValues,
				IntrospectionQuery__schema.class);
	 ...
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param name
	 *            Parameter for the __type field of IntrospectionQuery, as defined in the GraphQL schema
	 * @throws IOException
	 * @throws GraphQLRequestPreparationException
	 *             When an error occurs during the request preparation, typically when building the
	 *             {@link ObjectResponse}
	...
	public __Type __typeWithBindValues(ObjectResponse objectResponse, String name, Map<String, Object> parameters)
		...
		IntrospectionQuery__type ret = executor.execute("query", objectResponse, parameters,
				IntrospectionQuery__type.class);
	...
	public __Type __type(ObjectResponse objectResponse, String name, Object... paramsAndValues)
		...
		IntrospectionQuery__type ret = executor.execute("query", objectResponse, bindVariableValues,
				IntrospectionQuery__type.class);
