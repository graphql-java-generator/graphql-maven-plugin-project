...
public class AnotherMutationType {
	...
	public AnotherMutationTypeResponse execWithBindValues(ObjectResponse objectResponse, Map<String, Object> parameters)
		...
		return executor.execute(objectResponse, parameters, AnotherMutationTypeResponse.class);
	}
	...
	public Human createHumanWithBindValues(ObjectResponse objectResponse, HumanInput human,
		...
		AnotherMutationTypeCreateHuman ret = executor.execute(objectResponse, parameters,
	...
	public Human createHuman(ObjectResponse objectResponse, HumanInput human, Object... paramsAndValues)
		...
		AnotherMutationTypeCreateHuman ret = executor.execute(objectResponse, bindVariableValues,
				AnotherMutationTypeCreateHuman.class);
	...
	public AllFieldCases createAllFieldCasesWithBindValues(ObjectResponse objectResponse, AllFieldCasesInput input,
		...
		AnotherMutationTypeCreateAllFieldCases ret = executor.execute(objectResponse, parameters,
	...
	public AllFieldCases createAllFieldCases(ObjectResponse objectResponse, AllFieldCasesInput input,
		...
		AnotherMutationTypeCreateAllFieldCases ret = executor.execute(objectResponse, bindVariableValues,
				AnotherMutationTypeCreateAllFieldCases.class);
