...
/**
 * This class contains the methods that allows the execution of the queries or mutations that are defined in the AnotherMutationType of the GraphQL schema.<BR/>
...
public class AnotherMutationTypeExecutor {
	 ...
	 */
	@Autowired
	public AnotherMutationTypeExecutor() {
	 ...
	 */
	public AnotherMutationTypeExecutor(String graphqlEndpoint) {
	 ...
	 */
	public AnotherMutationTypeExecutor(String graphqlEndpoint, SSLContext sslContext, HostnameVerifier hostnameVerifier) {
	 ...
	 */
	public AnotherMutationTypeExecutor(String graphqlEndpoint, Client client, ObjectMapper objectMapper) {
 ...
 @GraphQLNonScalar (fieldName = "createAllFieldCases", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Boolean c = myQyeryType.deleteSnacksWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", id, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param id Parameter for the deleteSnacks field of AnotherMutationType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLScalar (fieldName = "deleteSnacks", graphQLTypeSimpleName = "Boolean", javaClass = Boolean.class)
	public Boolean deleteSnacksWithBindValues(String queryResponseDef, List<String> id, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 * 
	 * <PRE>
	 * Boolean c = myQyeryType.deleteSnacks("{id name @skip(if: false) appearsIn friends {id name}}", id, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 */
 @GraphQLScalar (fieldName = "deleteSnacks", graphQLTypeSimpleName = "Boolean", javaClass = Boolean.class)
	public Boolean deleteSnacks(String queryResponseDef, List<String> id, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing mutation 'deleteSnacks': {} ", queryResponseDef);
		ObjectResponse objectResponse = getDeleteSnacksResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return deleteSnacksWithBindValues(objectResponse, id, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLScalar (fieldName = "deleteSnacks", graphQLTypeSimpleName = "Boolean", javaClass = Boolean.class)
	public Boolean deleteSnacksWithBindValues(ObjectResponse objectResponse, List<String> id, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
 ...
 @GraphQLScalar (fieldName = "deleteSnacks", graphQLTypeSimpleName = "Boolean", javaClass = Boolean.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Boolean, as expected by the deleteSnacks query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
