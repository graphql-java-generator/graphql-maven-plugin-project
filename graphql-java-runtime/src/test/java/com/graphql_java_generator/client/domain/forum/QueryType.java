...
public class QueryType {
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * List<Board> c = myQyeryType.boardsWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 ...
	 * 
	 * <PRE>
	 * List<Board> c = myQyeryType.boards("{id name @skip(if: false) appearsIn friends {id name}}", "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	...
	public List<Board> boardsWithBindValues(ObjectResponse objectResponse, Map<String, Object> parameters)
		...
		QueryTypeBoards ret = configuration.getQueryExecutor().execute(objectResponse, parameters, QueryTypeBoards.class);
	...
	public List<Board> boards(ObjectResponse objectResponse, Object... paramsAndValues)
		...
		QueryTypeBoards ret = configuration.getQueryExecutor().execute(objectResponse, bindVariableValues, QueryTypeBoards.class);
	 ...
	 * 
	 * <PRE>
	 * Integer c = myQyeryType.nbBoards("{id name @skip(if: false) appearsIn friends {id name}}", "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	...
	public Integer nbBoards(String queryResponseDef, Object... paramsAndValues)
		...
		logger.debug("Executing of query 'nbBoards' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = getNbBoardsResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return nbBoardsWithBindValues(objectResponse, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public Integer nbBoardsWithBindValues(ObjectResponse objectResponse, Map<String, Object> parameters)
		...
		QueryTypeNbBoards ret = configuration.getQueryExecutor().execute(objectResponse, parameters, QueryTypeNbBoards.class);
	...
	public Integer nbBoards(ObjectResponse objectResponse, Object... paramsAndValues)
		...
		QueryTypeNbBoards ret = configuration.getQueryExecutor().execute(objectResponse, bindVariableValues, QueryTypeNbBoards.class);
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * List<Topic> c = myQyeryType.topicsWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", boardName, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * 
	 * <PRE>
	 * List<Topic> c = myQyeryType.topics("{id name @skip(if: false) appearsIn friends {id name}}", boardName, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	...
	public List<Topic> topics(String queryResponseDef, String boardName, Object... paramsAndValues)
		...
		logger.debug("Executing of query 'topics' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = getTopicsResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return topicsWithBindValues(objectResponse, boardName, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public List<Topic> topicsWithBindValues(ObjectResponse objectResponse, String boardName, Map<String, Object> parameters)
		...
		QueryTypeTopics ret = configuration.getQueryExecutor().execute(objectResponse, parameters, QueryTypeTopics.class);
	...
	public List<Topic> topics(ObjectResponse objectResponse, String boardName, Object... paramsAndValues)
		...
		QueryTypeTopics ret = configuration.getQueryExecutor().execute(objectResponse, bindVariableValues, QueryTypeTopics.class);
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * List<Topic> c = myQyeryType.findTopicsWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", boardName, keyword, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * 
	 * <PRE>
	 * List<Topic> c = myQyeryType.findTopics("{id name @skip(if: false) appearsIn friends {id name}}", boardName, keyword, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 */
	 @GraphQLNonScalar (fieldName = "findTopics", graphQLTypeName = "Topic", javaClass = Topic.class)
	public List<Topic> findTopics(String queryResponseDef, String boardName, List<String> keyword, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing of query 'findTopics' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = getFindTopicsResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return findTopicsWithBindValues(objectResponse, boardName, keyword, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public List<Topic> findTopicsWithBindValues(ObjectResponse objectResponse, String boardName, List<String> keyword, Map<String, Object> parameters)
		...
		QueryTypeFindTopics ret = configuration.getQueryExecutor().execute(objectResponse, parameters, QueryTypeFindTopics.class);
	...
	public List<Topic> findTopics(ObjectResponse objectResponse, String boardName, List<String> keyword, Object... paramsAndValues)
		...
		QueryTypeFindTopics ret = configuration.getQueryExecutor().execute(objectResponse, bindVariableValues, QueryTypeFindTopics.class);
