...
public class QueryType {
	...
	@GraphQLNonScalar(graphQLTypeName = "Int", javaClass = Integer.class)
	@GraphQLQuery
	public Integer nbBoards(ObjectResponse objectResponse) throws GraphQLRequestExecutionException {
		return nbBoardsWithBindValues(objectResponse, null);
	}
	...
	public List<Topic> findTopics(ObjectResponse objectResponse, String boardName, List<String> keyword,
		...
		QueryTypeFindTopics ret = executor.execute("query", objectResponse, bindVariableValues,
