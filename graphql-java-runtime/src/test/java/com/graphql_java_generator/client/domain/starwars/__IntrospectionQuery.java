...
public class __IntrospectionQuery {
	 ...
	 * @param name
	 *            Parameter for the __type field of __IntrospectionQuery, as defined in the GraphQL schema
	 * @throws IOException
	...
	@GraphQLNonScalar(graphQLTypeName = "__Type", javaClass = __Type.class)
	@GraphQLQuery
	public __Type __type(ObjectResponse objectResponse, String name) throws GraphQLRequestExecutionException {
		return __typeWithBindValues(objectResponse, name, null);
	}
	...
	public __Type __typeWithBindValues(ObjectResponse objectResponse, String name, Map<String, Object> parameters)
		...
		if (!objectResponse.getRequestType().equals(RequestType.query)
				|| !objectResponse.getQueryName().equals("__type")) {
		...
		__IntrospectionQuery__type ret = executor.execute("query", objectResponse, parameters,
				__IntrospectionQuery__type.class);
	...
	public __Type __type(ObjectResponse objectResponse, String name, Object... paramsAndValues)
		...
		__IntrospectionQuery__type ret = executor.execute("query", objectResponse, bindVariableValues,
				__IntrospectionQuery__type.class);
	...
	@GraphQLNonScalar(graphQLTypeName = "__Schema", javaClass = __Schema.class)
	@GraphQLQuery
	public __Schema __schema(ObjectResponse objectResponse) throws GraphQLRequestExecutionException {
		return __schemaWithBindValues(objectResponse, null);
	}
	...
	public __Schema __schemaWithBindValues(ObjectResponse objectResponse, Map<String, Object> parameters)
		...
		if (!objectResponse.getRequestType().equals(RequestType.query)
				|| !objectResponse.getQueryName().equals("__schema")) {
			throw new GraphQLRequestExecutionException("The ObjectResponse parameter should be an instance of "
					+ __Schema.class + ", but is an instance of " + objectResponse.getClass().getName());
		}

		__IntrospectionQuery__schema ret = executor.execute("query", objectResponse, parameters,
				__IntrospectionQuery__schema.class);
	...
	public __Schema __schema(ObjectResponse objectResponse, Object... paramsAndValues)
		...
		__IntrospectionQuery__schema ret = executor.execute("query", objectResponse, bindVariableValues,
				__IntrospectionQuery__schema.class);
