...
public class MyQueryTypeExecutor {
	 ...
	 */
	public MyQueryTypeExecutor(String graphqlEndpoint, Client client, GraphQLObjectMapper objectMapper) {
	...
	public Character withOneMandatoryParamDefaultValueWithBindValues(String queryResponseDef, Integer nbResultat,
			Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 */
	@GraphQLNonScalar(fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character withOneMandatoryParamDefaultValue(String queryResponseDef, Integer nbResultat,
	 ...
	 */
	@GraphQLNonScalar(fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character withOneMandatoryParamDefaultValueWithBindValues(ObjectResponse objectResponse, Integer nbResultat,
			Map<String, Object> parameters) throws GraphQLRequestExecutionException {
		if (logger.isTraceEnabled()) {
	 ...
	 */
	@GraphQLNonScalar(fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character withOneMandatoryParamDefaultValue(ObjectResponse objectResponse, Integer nbResultat,
			Object... paramsAndValues) throws GraphQLRequestExecutionException {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	public com.graphql_java_generator.client.request.Builder getWithOneMandatoryParamDefaultValueResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class,
				...
				InputParameter.newBindParameter("nbResultat", "myQueryTypeWithOneMandatoryParamDefaultValueNbResultat",
	...
	public AllFieldCases withListOfListWithBindValues(String queryResponseDef, List<List<List<Double>>> matrix,
			Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 */
	@GraphQLNonScalar(fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfList(String queryResponseDef, List<List<List<Double>>> matrix,
			Object... paramsAndValues) throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withListOfList': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithListOfListResponseBuilder().withQueryResponseDef(queryResponseDef)
				.build();
	 ...
	 */
	@GraphQLNonScalar(fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfListWithBindValues(ObjectResponse objectResponse, List<List<List<Double>>> matrix,
			Map<String, Object> parameters) throws GraphQLRequestExecutionException {
		if (logger.isTraceEnabled()) {
	 ...
	 */
	@GraphQLNonScalar(fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfList(ObjectResponse objectResponse, List<List<List<Double>>> matrix,
			Object... paramsAndValues) throws GraphQLRequestExecutionException {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	public com.graphql_java_generator.client.request.Builder getWithListOfListResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withListOfList",
				RequestType.query, InputParameter.newBindParameter("matrix", "myQueryTypeWithListOfListMatrix",
						InputParameterType.MANDATORY, "Float", true, 1, false));
	}
	...
	public GraphQLRequest getWithListOfListGraphQLRequest(String partialRequest)
		...
		return new GraphQLRequest(partialRequest, RequestType.query, "withListOfList", InputParameter.newBindParameter(
				"matrix", "myQueryTypeWithListOfListMatrix", InputParameterType.MANDATORY, "Float", true, 1, false));
	}
