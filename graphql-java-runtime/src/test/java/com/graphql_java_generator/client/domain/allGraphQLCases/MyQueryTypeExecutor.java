...
/**
 * This class contains the methods that allows the execution of the queries or mutations that are defined in the MyQueryType of the GraphQL schema.<BR/>
...
public class MyQueryTypeExecutor implements GraphQLQueryExecutor {
 ...
 @GraphQLNonScalar (fieldName = "withoutParameters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the withoutParameters query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithoutParametersResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withoutParameters", RequestType.query
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "withOneOptionalParam", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the withOneOptionalParam query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithOneOptionalParamResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withOneOptionalParam", RequestType.query
			, InputParameter.newBindParameter("character","myQueryTypeWithOneOptionalParamCharacter", InputParameterType.OPTIONAL, "CharacterInput", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "withOneMandatoryParam", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the withOneMandatoryParam query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithOneMandatoryParamResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withOneMandatoryParam", RequestType.query
			, InputParameter.newBindParameter("character","myQueryTypeWithOneMandatoryParamCharacter", InputParameterType.MANDATORY, "CharacterInput", true, 0, false)
			);
	}
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Integer c = myQyeryType.withOneMandatoryParamDefaultValueWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", intParam, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param intParam Parameter for the withOneMandatoryParamDefaultValue field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Int", javaClass = Integer.class)
	public Integer withOneMandatoryParamDefaultValueWithBindValues(String queryResponseDef, Integer intParam, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withOneMandatoryParamDefaultValue': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithOneMandatoryParamDefaultValueResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	 ...
	 * 
	 * <PRE>
	 * Integer c = myQyeryType.withOneMandatoryParamDefaultValue("{id name @skip(if: false) appearsIn friends {id name}}", intParam, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 */
 @GraphQLScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Int", javaClass = Integer.class)
	public Integer withOneMandatoryParamDefaultValue(String queryResponseDef, Integer intParam, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withOneMandatoryParamDefaultValue': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithOneMandatoryParamDefaultValueResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return withOneMandatoryParamDefaultValueWithBindValues(objectResponse, intParam, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Int", javaClass = Integer.class)
	public Integer withOneMandatoryParamDefaultValueWithBindValues(ObjectResponse objectResponse, Integer intParam, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
	 ...
	 */
 @GraphQLScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Int", javaClass = Integer.class)
	public Integer withOneMandatoryParamDefaultValue(ObjectResponse objectResponse, Integer intParam, Object... paramsAndValues)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Integer, as expected by the withOneMandatoryParamDefaultValue query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithOneMandatoryParamDefaultValueResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withOneMandatoryParamDefaultValue", RequestType.query
			, InputParameter.newBindParameter("intParam","myQueryTypeWithOneMandatoryParamDefaultValueIntParam", InputParameterType.MANDATORY, "Int", true, 0, false)
			);
	}


	/**
	 * Get the {@link GraphQLRequest} for the withOneMandatoryParamDefaultValue executor, created with the given Partial request.
	 * 
	 * @param partialRequest
	 * 				The Partial GraphQLRequest, as explained in the 
	 * 				<A HREF="https://graphql-maven-plugin-project.graphql-java-generator.com/client.html">plugin client documentation</A> 
	 ...
	 * @throws GraphQLRequestPreparationException
	 */
	public GraphQLRequest getWithOneMandatoryParamDefaultValueGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Droid c = myQyeryType.withTwoMandatoryParamDefaultValWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", theHero, num, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param theHero Parameter for the withTwoMandatoryParamDefaultVal field of MyQueryType, as defined in the GraphQL schema
	 * @param num Parameter for the withTwoMandatoryParamDefaultVal field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLNonScalar (fieldName = "withTwoMandatoryParamDefaultVal", graphQLTypeSimpleName = "Droid", javaClass = Droid.class)
	public Droid withTwoMandatoryParamDefaultValWithBindValues(String queryResponseDef, DroidInput theHero, Integer num, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withTwoMandatoryParamDefaultVal': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithTwoMandatoryParamDefaultValResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	 ...
	 * 
	 * <PRE>
	 * Droid c = myQyeryType.withTwoMandatoryParamDefaultVal("{id name @skip(if: false) appearsIn friends {id name}}", theHero, num, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withTwoMandatoryParamDefaultVal", graphQLTypeSimpleName = "Droid", javaClass = Droid.class)
	public Droid withTwoMandatoryParamDefaultVal(String queryResponseDef, DroidInput theHero, Integer num, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withTwoMandatoryParamDefaultVal': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithTwoMandatoryParamDefaultValResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return withTwoMandatoryParamDefaultValWithBindValues(objectResponse, theHero, num, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withTwoMandatoryParamDefaultVal", graphQLTypeSimpleName = "Droid", javaClass = Droid.class)
	public Droid withTwoMandatoryParamDefaultValWithBindValues(ObjectResponse objectResponse, DroidInput theHero, Integer num, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withTwoMandatoryParamDefaultVal", graphQLTypeSimpleName = "Droid", javaClass = Droid.class)
	public Droid withTwoMandatoryParamDefaultVal(ObjectResponse objectResponse, DroidInput theHero, Integer num, Object... paramsAndValues)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Droid, as expected by the withTwoMandatoryParamDefaultVal query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithTwoMandatoryParamDefaultValResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withTwoMandatoryParamDefaultVal", RequestType.query
			, InputParameter.newBindParameter("theHero","myQueryTypeWithTwoMandatoryParamDefaultValTheHero", InputParameterType.MANDATORY, "DroidInput", true, 0, false)
			, InputParameter.newBindParameter("num","myQueryTypeWithTwoMandatoryParamDefaultValNum", InputParameterType.OPTIONAL, "Int", false, 0, false)
			);
	}


	/**
	 * Get the {@link GraphQLRequest} for the withTwoMandatoryParamDefaultVal executor, created with the given Partial request.
	 * 
	 * @param partialRequest
	 * 				The Partial GraphQLRequest, as explained in the 
	 * 				<A HREF="https://graphql-maven-plugin-project.graphql-java-generator.com/client.html">plugin client documentation</A> 
	 ...
	 * @throws GraphQLRequestPreparationException
	 */
	public GraphQLRequest getWithTwoMandatoryParamDefaultValGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
 ...
 @GraphQLNonScalar (fieldName = "withEnum", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the withEnum query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithEnumResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withEnum", RequestType.query
			, InputParameter.newBindParameter("episode","myQueryTypeWithEnumEpisode", InputParameterType.MANDATORY, "Episode", true, 0, false)
			);
	}
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * AllFieldCases c = myQyeryType.withListOfListWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", matrix, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param matrix Parameter for the withListOfList field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfListWithBindValues(String queryResponseDef, List<List<Double>> matrix, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withListOfList': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithListOfListResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	 ...
	 * 
	 * <PRE>
	 * AllFieldCases c = myQyeryType.withListOfList("{id name @skip(if: false) appearsIn friends {id name}}", matrix, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfList(String queryResponseDef, List<List<Double>> matrix, Object... paramsAndValues)
		...
		logger.debug("Executing query 'withListOfList': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithListOfListResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return withListOfListWithBindValues(objectResponse, matrix, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfListWithBindValues(ObjectResponse objectResponse, List<List<Double>> matrix, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfList(ObjectResponse objectResponse, List<List<Double>> matrix, Object... paramsAndValues)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the AllFieldCases, as expected by the withListOfList query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithListOfListResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withListOfList", RequestType.query
			, InputParameter.newBindParameter("matrix","myQueryTypeWithListOfListMatrix", InputParameterType.MANDATORY, "Float", true, 2, false)
			);
	}
	 ...
	 * @throws GraphQLRequestPreparationException
	 */
	public GraphQLRequest getWithListOfListGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
 ...
 @GraphQLNonScalar (fieldName = "withList", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the withList query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithListResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withList", RequestType.query
			, InputParameter.newBindParameter("firstName","myQueryTypeWithListFirstName", InputParameterType.MANDATORY, "String", true, 0, false)
			, InputParameter.newBindParameter("characters","myQueryTypeWithListCharacters", InputParameterType.MANDATORY, "CharacterInput", true, 1, true)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "allFieldCases", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the AllFieldCases, as expected by the allFieldCases query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getAllFieldCasesResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "allFieldCases", RequestType.query
			, InputParameter.newBindParameter("input","myQueryTypeAllFieldCasesInput", InputParameterType.OPTIONAL, "AllFieldCasesInput", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "unionTest", graphQLTypeSimpleName = "AnyCharacter", javaClass = AnyCharacter.class)
	public List<AnyCharacter> unionTestWithBindValues(ObjectResponse objectResponse, HumanInput human1, HumanInput human2, DroidInput droid1, DroidInput droid2, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			logger.trace("Executing query 'unionTest' with parameters: {}, {}, {}, {} ", human1, human2, droid1, droid2);
		} else if (logger.isDebugEnabled()) {
 ...
 @GraphQLNonScalar (fieldName = "unionTest", graphQLTypeSimpleName = "AnyCharacter", javaClass = AnyCharacter.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the AnyCharacter, as expected by the unionTest query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getUnionTestResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "unionTest", RequestType.query
			, InputParameter.newBindParameter("human1","myQueryTypeUnionTestHuman1", InputParameterType.OPTIONAL, "HumanInput", false, 0, false)
			, InputParameter.newBindParameter("human2","myQueryTypeUnionTestHuman2", InputParameterType.OPTIONAL, "HumanInput", false, 0, false)
			, InputParameter.newBindParameter("droid1","myQueryTypeUnionTestDroid1", InputParameterType.OPTIONAL, "DroidInput", false, 0, false)
			, InputParameter.newBindParameter("droid2","myQueryTypeUnionTestDroid2", InputParameterType.OPTIONAL, "DroidInput", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "error", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the error query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getErrorResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "error", RequestType.query
			, InputParameter.newBindParameter("errorLabel","myQueryTypeErrorErrorLabel", InputParameterType.MANDATORY, "String", true, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "aBreak", graphQLTypeSimpleName = "break", javaClass = _break.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the _break, as expected by the aBreak query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getABreakResponseBuilder() throws GraphQLRequestPreparationException {
 ...
 @GraphQLScalar (fieldName = "directiveOnQuery", graphQLTypeSimpleName = "String", javaClass = String.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the String, as expected by the directiveOnQuery query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getDirectiveOnQueryResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "directiveOnQuery", RequestType.query
			, InputParameter.newBindParameter("uppercase","myQueryTypeDirectiveOnQueryUppercase", InputParameterType.OPTIONAL, "Boolean", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "directiveOnField", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the directiveOnField query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getDirectiveOnFieldResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "directiveOnField", RequestType.query
			);
	}
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * List<Character> c = myQyeryType.connectionWithoutParametersWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "connectionWithoutParameters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public List<Character> connectionWithoutParametersWithBindValues(String queryResponseDef, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'connectionWithoutParameters': {} ", queryResponseDef);
		ObjectResponse objectResponse = getConnectionWithoutParametersResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	 ...
	 * 
	 * <PRE>
	 * List<Character> c = myQyeryType.connectionWithoutParameters("{id name @skip(if: false) appearsIn friends {id name}}", "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "connectionWithoutParameters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public List<Character> connectionWithoutParameters(String queryResponseDef, Object... paramsAndValues)
		...
		logger.debug("Executing query 'connectionWithoutParameters': {} ", queryResponseDef);
		ObjectResponse objectResponse = getConnectionWithoutParametersResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return connectionWithoutParametersWithBindValues(objectResponse, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLNonScalar (fieldName = "connectionWithoutParameters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public List<Character> connectionWithoutParametersWithBindValues(ObjectResponse objectResponse, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
 ...
 @GraphQLNonScalar (fieldName = "connectionWithoutParameters", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the connectionWithoutParameters query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getConnectionWithoutParametersResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "connectionWithoutParameters", RequestType.query
			);
	}
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link GraphQLRequest} for the connectionWithoutParameters executor, created with the given Partial request.
	 * 
	 * @param partialRequest
	 * 				The Partial GraphQLRequest, as explained in the 
	 * 				<A HREF="https://graphql-maven-plugin-project.graphql-java-generator.com/client.html">plugin client documentation</A> 
	 ...
	 * @throws GraphQLRequestPreparationException
	 */
	public GraphQLRequest getConnectionWithoutParametersGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * List<Human> c = myQyeryType.connectionOnHumanWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", planet, episode, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param planet Parameter for the connectionOnHuman field of MyQueryType, as defined in the GraphQL schema
	 * @param episode Parameter for the connectionOnHuman field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLNonScalar (fieldName = "connectionOnHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public List<Human> connectionOnHumanWithBindValues(String queryResponseDef, String planet, Episode episode, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'connectionOnHuman': {} ", queryResponseDef);
		ObjectResponse objectResponse = getConnectionOnHumanResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	 ...
	 * 
	 * <PRE>
	 * List<Human> c = myQyeryType.connectionOnHuman("{id name @skip(if: false) appearsIn friends {id name}}", planet, episode, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 */
 @GraphQLNonScalar (fieldName = "connectionOnHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public List<Human> connectionOnHuman(String queryResponseDef, String planet, Episode episode, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'connectionOnHuman': {} ", queryResponseDef);
		ObjectResponse objectResponse = getConnectionOnHumanResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return connectionOnHumanWithBindValues(objectResponse, planet, episode, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLNonScalar (fieldName = "connectionOnHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public List<Human> connectionOnHumanWithBindValues(ObjectResponse objectResponse, String planet, Episode episode, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "connectionOnHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public List<Human> connectionOnHuman(ObjectResponse objectResponse, String planet, Episode episode, Object... paramsAndValues)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Human, as expected by the connectionOnHuman query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getConnectionOnHumanResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "connectionOnHuman", RequestType.query
			, InputParameter.newBindParameter("planet","myQueryTypeConnectionOnHumanPlanet", InputParameterType.OPTIONAL, "String", false, 0, false)
			, InputParameter.newBindParameter("episode","myQueryTypeConnectionOnHumanEpisode", InputParameterType.OPTIONAL, "Episode", false, 0, false)
			);
	}
	 ...
	 * @throws GraphQLRequestPreparationException
	 */
	public GraphQLRequest getConnectionOnHumanGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Date c = myQyeryType.issue53WithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", date, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param date Parameter for the issue53 field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLScalar (fieldName = "issue53", graphQLTypeSimpleName = "Date", javaClass = Date.class)
	 ...
	 * 
	 * <PRE>
	 * Date c = myQyeryType.issue53("{id name @skip(if: false) appearsIn friends {id name}}", date, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLScalar (fieldName = "issue53", graphQLTypeSimpleName = "Date", javaClass = Date.class)
	public Date issue53(String queryResponseDef, Date date, Object... paramsAndValues)
		...
		logger.debug("Executing query 'issue53': {} ", queryResponseDef);
		ObjectResponse objectResponse = getIssue53ResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return issue53WithBindValues(objectResponse, date, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
 ...
 @GraphQLScalar (fieldName = "issue53", graphQLTypeSimpleName = "Date", javaClass = Date.class)
	...
	public com.graphql_java_generator.client.request.Builder getIssue53ResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "issue53", RequestType.query
			, InputParameter.newBindParameter("date","myQueryTypeIssue53Date", InputParameterType.MANDATORY, "Date", true, 0, false)
			);
	}
	...
	public GraphQLRequest getIssue53GraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
		return new GraphQLRequest(partialRequest, RequestType.query, "issue53"
  		, InputParameter.newBindParameter("date","myQueryTypeIssue53Date", InputParameterType.MANDATORY, "Date", true, 0, false)
		);
	}
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Double c = myQyeryType.issue82FloatWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", aFloat, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param aFloat Parameter for the issue82Float field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLScalar (fieldName = "issue82Float", graphQLTypeSimpleName = "Float", javaClass = Double.class)
	 ...
	 * 
	 * <PRE>
	 * Double c = myQyeryType.issue82Float("{id name @skip(if: false) appearsIn friends {id name}}", aFloat, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLScalar (fieldName = "issue82Float", graphQLTypeSimpleName = "Float", javaClass = Double.class)
	public Double issue82Float(String queryResponseDef, Double aFloat, Object... paramsAndValues)
		...
		logger.debug("Executing query 'issue82Float': {} ", queryResponseDef);
		ObjectResponse objectResponse = getIssue82FloatResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return issue82FloatWithBindValues(objectResponse, aFloat, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLScalar (fieldName = "issue82Float", graphQLTypeSimpleName = "Float", javaClass = Double.class)
	public Double issue82FloatWithBindValues(ObjectResponse objectResponse, Double aFloat, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
 ...
 @GraphQLScalar (fieldName = "issue82Float", graphQLTypeSimpleName = "Float", javaClass = Double.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Double, as expected by the issue82Float query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getIssue82FloatResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "issue82Float", RequestType.query
			, InputParameter.newBindParameter("aFloat","myQueryTypeIssue82FloatAFloat", InputParameterType.MANDATORY, "Float", true, 0, false)
			);
	}
	 ...
	 * @throws GraphQLRequestPreparationException
	 */
	public GraphQLRequest getIssue82FloatGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * String c = myQyeryType.issue82IDWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", aID, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param aID Parameter for the issue82ID field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLScalar (fieldName = "issue82ID", graphQLTypeSimpleName = "ID", javaClass = String.class)
	 ...
	 * 
	 * <PRE>
	 * String c = myQyeryType.issue82ID("{id name @skip(if: false) appearsIn friends {id name}}", aID, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLScalar (fieldName = "issue82ID", graphQLTypeSimpleName = "ID", javaClass = String.class)
	public String issue82ID(String queryResponseDef, String aID, Object... paramsAndValues)
		...
		logger.debug("Executing query 'issue82ID': {} ", queryResponseDef);
		ObjectResponse objectResponse = getIssue82IDResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return issue82IDWithBindValues(objectResponse, aID, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
 ...
 @GraphQLScalar (fieldName = "issue82ID", graphQLTypeSimpleName = "ID", javaClass = String.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the String, as expected by the issue82ID query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getIssue82IDResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "issue82ID", RequestType.query
			, InputParameter.newBindParameter("aID","myQueryTypeIssue82IDAID", InputParameterType.MANDATORY, "ID", true, 0, false)
			);
	}
	...
	public GraphQLRequest getIssue82IDGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
		return new GraphQLRequest(partialRequest, RequestType.query, "issue82ID"
  		, InputParameter.newBindParameter("aID","myQueryTypeIssue82IDAID", InputParameterType.MANDATORY, "ID", true, 0, false)
		);
	}
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * MyQueryType c = myQyeryType.relayWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "relay", graphQLTypeSimpleName = "MyQueryType", javaClass = MyQueryType.class)
	 ...
	 * 
	 * <PRE>
	 * MyQueryType c = myQyeryType.relay("{id name @skip(if: false) appearsIn friends {id name}}", "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "relay", graphQLTypeSimpleName = "MyQueryType", javaClass = MyQueryType.class)
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the MyQueryType, as expected by the relay query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getRelayResponseBuilder() throws GraphQLRequestPreparationException {
 ...
 @GraphQLNonScalar (fieldName = "__type", graphQLTypeSimpleName = "__Type", javaClass = __Type.class)
	...
	public com.graphql_java_generator.client.request.Builder get__typeResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "__type", RequestType.query
			, InputParameter.newBindParameter("name","myQueryType__typeName", InputParameterType.MANDATORY, "String", true, 0, false)
			);
	}
