 ...
 */
@Component
public class MyQueryTypeExecutor {
	 ...
	 */
	public MyQueryTypeExecutor(String graphqlEndpoint, Client client, ObjectMapper objectMapper) {
 ...
 @GraphQLNonScalar (fieldName = "withOneMandatoryParam", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Character c = myQyeryType.withOneMandatoryParamDefaultValueWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", nbResultat, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param nbResultat Parameter for the withOneMandatoryParamDefaultValue field of MyQueryType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLNonScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character withOneMandatoryParamDefaultValueWithBindValues(String queryResponseDef, Integer nbResultat, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 * 
	 * <PRE>
	 * Character c = myQyeryType.withOneMandatoryParamDefaultValue("{id name @skip(if: false) appearsIn friends {id name}}", nbResultat, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character withOneMandatoryParamDefaultValue(String queryResponseDef, Integer nbResultat, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withOneMandatoryParamDefaultValue': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithOneMandatoryParamDefaultValueResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return withOneMandatoryParamDefaultValueWithBindValues(objectResponse, nbResultat, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character withOneMandatoryParamDefaultValueWithBindValues(ObjectResponse objectResponse, Integer nbResultat, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			logger.trace("Executing query 'withOneMandatoryParamDefaultValue' with parameters: {} ", nbResultat);
		} else if (logger.isDebugEnabled()) {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public Character withOneMandatoryParamDefaultValue(ObjectResponse objectResponse, Integer nbResultat, Object... paramsAndValues)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the withOneMandatoryParamDefaultValue query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getWithOneMandatoryParamDefaultValueResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withOneMandatoryParamDefaultValue", RequestType.query
			, InputParameter.newBindParameter("nbResultat","myQueryTypeWithOneMandatoryParamDefaultValueNbResultat", InputParameterType.MANDATORY, "Int", true, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfListWithBindValues(String queryResponseDef, List<List<List<Double>>> matrix, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfList(String queryResponseDef, List<List<List<Double>>> matrix, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing query 'withListOfList': {} ", queryResponseDef);
		ObjectResponse objectResponse = getWithListOfListResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfListWithBindValues(ObjectResponse objectResponse, List<List<List<Double>>> matrix, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public AllFieldCases withListOfList(ObjectResponse objectResponse, List<List<List<Double>>> matrix, Object... paramsAndValues)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
	...
	public com.graphql_java_generator.client.request.Builder getWithListOfListResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "withListOfList", RequestType.query
			, InputParameter.newBindParameter("matrix","myQueryTypeWithListOfListMatrix", InputParameterType.MANDATORY, "Float", true, 1, false)
			);
	}
