...
public class SubscriptionTypeExecutor {
	...
	public SubscriptionClient newCharacter(String queryResponseDef, 
		...
		ObjectResponse objectResponse = getNewCharacterResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return newCharacterWithBindValues(objectResponse, subscriptionCallback, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public SubscriptionClient newCharacterWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, "newCharacter", SubscriptionType.class, Character.class);
	}
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Character, as expected by the newCharacter subscription.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getNewCharacterResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "newCharacter", RequestType.subscription
			);
	}
