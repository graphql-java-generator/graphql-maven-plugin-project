...
public class AllFieldCasesInterfaceType implements AllFieldCasesInterface, WithID {
	...
	public static enum Field implements GraphQLField {
		Id("id"), Name("name"), Forname("forname"), Age("age"), NbComments("nbComments"), Comments(
				"comments"), Booleans("booleans"), Aliases("aliases"), Planets("planets"), Friends(
						"friends"), OneWithIdSubType("oneWithIdSubType"), ListWithIdSubTypes(
								"listWithIdSubTypes"), OneWithoutIdSubType(
										"oneWithoutIdSubType"), ListWithoutIdSubTypes(
												"listWithoutIdSubTypes"), __typename("__typename");
