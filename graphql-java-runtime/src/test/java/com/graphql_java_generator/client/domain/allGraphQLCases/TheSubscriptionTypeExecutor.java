...
public class TheSubscriptionTypeExecutor  implements GraphQLSubscriptionExecutor {
	...
	public SubscriptionClient execWithBindValues(ObjectResponse objectResponse, 
		...
		case "subscribeNewHumanForEpisode":
			return configuration.getQueryExecutor().execute(objectResponse, parameters,
					...
					TheSubscriptionTypeResponse.class, 
					Human.class);
		case "subscribeToAList":
			return configuration.getQueryExecutor().execute(objectResponse, parameters,
					(SubscriptionCallback<Integer>) subscriptionCallback, 
					TheSubscriptionTypeResponse.class, 
					Integer.class);
		case "issue53":
			return configuration.getQueryExecutor().execute(objectResponse, parameters,
	...
	public SubscriptionClient subscribeNewHumanForEpisodeWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, TheSubscriptionType.class, Human.class);
	}
	...
	public SubscriptionClient subscribeToAListWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, (SubscriptionCallback<List>) (Object) subscriptionCallback, TheSubscriptionType.class, List.class);
	}
	...
	public SubscriptionClient issue53WithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, TheSubscriptionType.class, Date.class);
	}
