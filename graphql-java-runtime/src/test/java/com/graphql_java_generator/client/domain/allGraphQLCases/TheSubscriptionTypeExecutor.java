...
/**
 * This class contains the methods that allows the execution of the subscriptions that are defined in the TheSubscriptionType of the GraphQL schema.<BR/>
...
public class TheSubscriptionTypeExecutor {
	 ...
	 */
	@Autowired
	public TheSubscriptionTypeExecutor() {
	 ...
	 */
	public TheSubscriptionTypeExecutor(String graphqlEndpoint) {
	 ...
	 */
	public TheSubscriptionTypeExecutor(String graphqlEndpoint, SSLContext sslContext, HostnameVerifier hostnameVerifier) {
	 ...
	 */
	public TheSubscriptionTypeExecutor(String graphqlEndpoint, Client client, ObjectMapper objectMapper) {
	 ...
	 *            An instance of SubscriptionCallback<Human>. Its {@link SubscriptionCallback#onMessage(Object)} 
	...
	public SubscriptionClient subscribeNewHumanForEpisode(String queryResponseDef, 
			...
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing subscription 'subscribeNewHumanForEpisode' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = getSubscribeNewHumanForEpisodeResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return subscribeNewHumanForEpisodeWithBindValues(objectResponse, subscriptionCallback, episode, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public SubscriptionClient subscribeNewHumanForEpisodeWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, "subscribeNewHumanForEpisode", TheSubscriptionType.class, Human.class);
	}
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Human, as expected by the subscribeNewHumanForEpisode subscription.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link GraphQLRequest} for the subscribeNewHumanForEpisode executor, created with the given Partial request.
	 * 
	 ...
	 *            The response definition of the subscription, in the native GraphQL format (see here above)
	 * @param subscriptionCallback
	 *            An instance of SubscriptionCallback<Integer>. Its {@link SubscriptionCallback#onMessage(Object)} 
	 *            will be called for each notification received from this subscription.
	 * @param parameters
	 *            The list of values, for the bind variables defined in the subscription. If there is no bind variable in the
	 *            defined subscription, this argument may be null or an empty {@link Map}
	...
	public SubscriptionClient subscribeToAListWithBindValues(String queryResponseDef, 
			SubscriptionCallback<List<Integer>> subscriptionCallback
			, 
			Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing subscription 'subscribeToAList': {} ", queryResponseDef);
		ObjectResponse objectResponse = getSubscribeToAListResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	...
	public SubscriptionClient subscribeToAList(String queryResponseDef, 
			...
			Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing subscription 'subscribeToAList' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = getSubscribeToAListResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return subscribeToAListWithBindValues(objectResponse, subscriptionCallback, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Integer, as expected by the subscribeToAList subscription.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getSubscribeToAListResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "subscribeToAList", RequestType.subscription
			);
	}
	 ...
	 *            The response definition of the subscription, in the native GraphQL format (see here above)
	 * @param subscriptionCallback
	 *            An instance of SubscriptionCallback<Date>. Its {@link SubscriptionCallback#onMessage(Object)} 
	 *            will be called for each notification received from this subscription.
	 * @param date Parameter for the issue53 field of TheSubscriptionType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the subscription. If there is no bind variable in the
	 *            defined subscription, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
	...
	public SubscriptionClient issue53WithBindValues(String queryResponseDef, 
			SubscriptionCallback<Date> subscriptionCallback
			, Date date, 
			Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	public SubscriptionClient issue53(String queryResponseDef, 
			...
			Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing subscription 'issue53' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = getIssue53ResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return issue53WithBindValues(objectResponse, subscriptionCallback, date, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public SubscriptionClient issue53WithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, "issue53", TheSubscriptionType.class, Date.class);
	}
	 ...
	 * ${field.content}
	 * <BR/>
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Date, as expected by the issue53 subscription.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	 ...
	 *            The response definition of the subscription, in the native GraphQL format (see here above)
	 * @param subscriptionCallback
	 *            An instance of SubscriptionCallback<String>. Its {@link SubscriptionCallback#onMessage(Object)} 
	 *            will be called for each notification received from this subscription.
	 * @param parameters
	 *            The list of values, for the bind variables defined in the subscription. If there is no bind variable in the
	 *            defined subscription, this argument may be null or an empty {@link Map}
	...
	public SubscriptionClient __typenameWithBindValues(String queryResponseDef, 
			SubscriptionCallback<String> subscriptionCallback
			, 
			Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing subscription '__typename': {} ", queryResponseDef);
		ObjectResponse objectResponse = get__typenameResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return __typename(objectResponse, subscriptionCallback, parameters);
	}
	...
	public SubscriptionClient __typename(String queryResponseDef, 
			...
			Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing subscription '__typename' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = get__typenameResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return __typenameWithBindValues(objectResponse, subscriptionCallback, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public SubscriptionClient __typenameWithBindValues(ObjectResponse objectResponse,
			...
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
			logger.trace("Executing subscription '__typename' with parameters: ");
		} else if (logger.isDebugEnabled()) {
			logger.debug("Executing subscription '__typename'");
		}
	
		// Given values for the BindVariables
		parameters = (parameters != null) ? parameters : new HashMap<>();

		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, "__typename", TheSubscriptionType.class, String.class);
	}
	...
	public SubscriptionClient __typename(ObjectResponse objectResponse,
		...
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
			sb.append("Executing subscription '__typename' with bind variables: ");
			boolean addComma = false;
			for (Object o : paramsAndValues) {
				if (o != null) {
					sb.append(o.toString());
			...
			logger.debug("Executing subscription '__typename' (with bind variables)");
		}
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the String, as expected by the __typename subscription.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder get__typenameResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "__typename", RequestType.subscription
			);
	}
	...
	public GraphQLRequest get__typenameGraphQLRequest(String partialRequest) throws GraphQLRequestPreparationException {
		GraphQLRequest ret = new GraphQLRequest(partialRequest, RequestType.subscription, "__typename"
		);
		ret.setInstanceConfiguration(configuration);
		return ret;
	}
