...
public class TheSubscriptionTypeExecutor {
	...
	public SubscriptionClient subscribeToAListWithBindValues(String queryResponseDef,
			SubscriptionCallback<List<Integer>> subscriptionCallback, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	public com.graphql_java_generator.client.request.Builder getSubscribeToAListResponseBuilder()
			throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "subscribeToAList",
	...
	public SubscriptionClient issue53WithBindValues(String queryResponseDef,
			SubscriptionCallback<Date> subscriptionCallback, Date date, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 *             GraphQL server or if the server response can't be parsed
	 */
	public SubscriptionClient issue53(String queryResponseDef, SubscriptionCallback<Date> subscriptionCallback,
			Date date, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	public SubscriptionClient __typenameWithBindValues(String queryResponseDef,
			SubscriptionCallback<String> subscriptionCallback, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 *             GraphQL server or if the server response can't be parsed
	 */
	public SubscriptionClient __typename(String queryResponseDef, SubscriptionCallback<String> subscriptionCallback,
		...
		ObjectResponse objectResponse = get__typenameResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return __typenameWithBindValues(objectResponse, subscriptionCallback,
				graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public SubscriptionClient __typenameWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback,
				TheSubscriptionType.class, String.class);
	}
	...
	public SubscriptionClient __typename(ObjectResponse objectResponse,
			SubscriptionCallback<String> subscriptionCallback, Object... paramsAndValues)
			throws GraphQLRequestExecutionException {
		if (logger.isTraceEnabled()) {
			StringBuffer sb = new StringBuffer();
