...
public class MutationTypeExecutor {
 ...
 @GraphQLNonScalar (fieldName = "createBoard", graphQLTypeSimpleName = "Board", javaClass = Board.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Board, as expected by the createBoard query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getCreateBoardResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "createBoard", RequestType.mutation
			, InputParameter.newBindParameter("name","mutationTypeCreateBoardName", InputParameterType.MANDATORY, "String", true, 0, false)
			, InputParameter.newBindParameter("publiclyAvailable","mutationTypeCreateBoardPubliclyAvailable", InputParameterType.OPTIONAL, "Boolean", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "createTopic", graphQLTypeSimpleName = "Topic", javaClass = Topic.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Topic, as expected by the createTopic query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getCreateTopicResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "createTopic", RequestType.mutation
			, InputParameter.newBindParameter("topic","mutationTypeCreateTopicTopic", InputParameterType.OPTIONAL, "TopicInput", false, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "createPost", graphQLTypeSimpleName = "Post", javaClass = Post.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Post, as expected by the createPost query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getCreatePostResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "createPost", RequestType.mutation
			, InputParameter.newBindParameter("post","mutationTypeCreatePostPost", InputParameterType.MANDATORY, "PostInput", true, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "createPosts", graphQLTypeSimpleName = "Post", javaClass = Post.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Post, as expected by the createPosts query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getCreatePostsResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "createPosts", RequestType.mutation
			, InputParameter.newBindParameter("spam","mutationTypeCreatePostsSpam", InputParameterType.MANDATORY, "PostInput", true, 1, true)
			);
	}
	 ...
	 * params.put("skip", Boolean.FALSE);
	 *
	 * Member c = myQyeryType.createMemberWithBindValues("{id name @skip(if: false) appearsIn friends {id name}}", input, params);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
	 ...
	 * @param queryResponseDef
	 *            The response definition of the query, in the native GraphQL format (see here above)
	 * @param input Parameter for the createMember field of MutationType, as defined in the GraphQL schema
	 * @param parameters
	 *            The list of values, for the bind variables defined in the query. If there is no bind variable in the
	 *            defined Query, this argument may be null or an empty {@link Map}
	 * @throws GraphQLRequestPreparationException
 ...
 @GraphQLNonScalar (fieldName = "createMember", graphQLTypeSimpleName = "Member", javaClass = Member.class)
	 ...
	 * 
	 * <PRE>
	 * Member c = myQyeryType.createMember("{id name @skip(if: false) appearsIn friends {id name}}", input, "skip", Boolean.FALSE);
	 * </PRE>
	 * 
	 * It offers a logging of the call (if in debug mode), or of the call and its parameters (if in trace mode).<BR/>
	 * This method takes care of writing the query name, and the parameter(s) for the query. The given queryResponseDef
 ...
 @GraphQLNonScalar (fieldName = "createMember", graphQLTypeSimpleName = "Member", javaClass = Member.class)
	public Member createMember(String queryResponseDef, MemberInput input, Object... paramsAndValues)
		...
		logger.debug("Executing mutation 'createMember': {} ", queryResponseDef);
		ObjectResponse objectResponse = getCreateMemberResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return createMemberWithBindValues(objectResponse, input, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 */
 @GraphQLNonScalar (fieldName = "createMember", graphQLTypeSimpleName = "Member", javaClass = Member.class)
	public Member createMemberWithBindValues(ObjectResponse objectResponse, MemberInput input, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
 ...
 @GraphQLNonScalar (fieldName = "createMember", graphQLTypeSimpleName = "Member", javaClass = Member.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Member, as expected by the createMember query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getCreateMemberResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "createMember", RequestType.mutation
			, InputParameter.newBindParameter("input","mutationTypeCreateMemberInput", InputParameterType.MANDATORY, "MemberInput", true, 0, false)
			);
	}
