...
public class TheSubscriptionType {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "subscribeNewHumanForEpisode", graphQLTypeName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.allGraphQLCases.Human subscribeNewHumanForEpisodeWithBindValues(String queryResponseDef, Episode episode, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	 ...
	 */
 @GraphQLNonScalar (fieldName = "subscribeNewHumanForEpisode", graphQLTypeName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.allGraphQLCases.Human subscribeNewHumanForEpisode(String queryResponseDef, Episode episode, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		logger.debug("Executing of query 'subscribeNewHumanForEpisode' in query mode: {} ", queryResponseDef);
		ObjectResponse objectResponse = getSubscribeNewHumanForEpisodeResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	 ...
	 */
 @GraphQLNonScalar (fieldName = "subscribeNewHumanForEpisode", graphQLTypeName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.allGraphQLCases.Human subscribeNewHumanForEpisodeWithBindValues(ObjectResponse objectResponse, Episode episode, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
		...
		TheSubscriptionType ret = configuration.getQueryExecutor().execute(objectResponse, parameters, TheSubscriptionType.class);
	 ...
	 */
 @GraphQLNonScalar (fieldName = "subscribeNewHumanForEpisode", graphQLTypeName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.allGraphQLCases.Human subscribeNewHumanForEpisode(ObjectResponse objectResponse, Episode episode, Object... paramsAndValues)
			throws GraphQLRequestExecutionException  {
		if (logger.isTraceEnabled()) {
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Human, as expected by the subscribeNewHumanForEpisode query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
