...
public class __Type {
	...
	@GraphQLInputParameters(names = { "includeDeprecated" }, types = { "Boolean" }, mandatories = {
	...
	public String toString() {
		return "__Type {" + "kind: " + kind + ", " + "name: " + name + ", " + "description: " + description + ", "
				+ "fields: " + fields + ", " + "interfaces: " + interfaces + ", " + "possibleTypes: " + possibleTypes
				+ ", " + "enumValues: " + enumValues + ", " + "inputFields: " + inputFields + ", " + "ofType: " + ofType
	...
	public static enum Field implements GraphQLField {
		Kind("kind"), Name("name"), Description("description"), Fields("fields"), Interfaces(
				"interfaces"), PossibleTypes("possibleTypes"), EnumValues(
						"enumValues"), InputFields("inputFields"), OfType("ofType"), __typename("__typename");
