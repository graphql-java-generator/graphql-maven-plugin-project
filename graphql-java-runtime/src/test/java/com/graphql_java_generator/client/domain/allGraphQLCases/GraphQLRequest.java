...
public class GraphQLRequest extends ObjectResponse {
	...
	public <T> SubscriptionClient execSubscription(SubscriptionCallback<T> subscriptionCallback,
			String subscriptionName, Class<T> messageType, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException {
		return exec(parameters, subscriptionCallback, subscriptionName, TheSubscriptionType.class, messageType);
	}
	 ...
	 */
	public <T> SubscriptionClient execSubscription(SubscriptionCallback<T> subscriptionCallback,
			String subscriptionName, Class<T> messageType, Object... paramsAndValues)
			throws GraphQLRequestExecutionException {
		return exec(graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues), subscriptionCallback,
				subscriptionName, TheSubscriptionType.class, messageType);
	}
