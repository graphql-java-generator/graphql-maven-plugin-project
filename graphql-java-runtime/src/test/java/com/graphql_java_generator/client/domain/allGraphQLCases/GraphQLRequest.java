...
public class GraphQLRequest extends ObjectResponse {
	...
	public AnotherMutationTypeResponse execMutation(Object... paramsAndValues) throws GraphQLRequestExecutionException {
		return exec(AnotherMutationTypeResponse.class, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	 ...
	 *             GraphQL server or if the server response can't be parsed
	 */
	public TheSubscriptionTypeResponse execSubscription(Object... paramsAndValues) throws GraphQLRequestExecutionException {
		throw new GraphQLRequestExecutionException("Subscriptions are not managed yet");
	}
