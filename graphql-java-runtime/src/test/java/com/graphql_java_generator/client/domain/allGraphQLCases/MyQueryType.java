...
public class MyQueryType {
	...
	@GraphQLNonScalar(fieldName = "withOneMandatoryParamDefaultValue", graphQLTypeName = "Character", javaClass = Character.class)
	...
	@GraphQLNonScalar(fieldName = "withTwoMandatoryParamDefaultVal", graphQLTypeName = "Droid", javaClass = Droid.class)
	...
	@JsonProperty("relay")
	@GraphQLNonScalar(fieldName = "relay", graphQLTypeName = "MyQueryType", javaClass = MyQueryType.class)
	MyQueryType relay;
