...
public class MyQueryType extends MyQueryTypeExecutor implements com.graphql_java_generator.client.GraphQLRequestObject {
	...
	@GraphQLInputParameters(names = { "character" }, types = { "CharacterInput" }, mandatories = { false }, listDepths = {
	...
	@GraphQLInputParameters(names = { "character" }, types = { "CharacterInput" }, mandatories = { true }, listDepths = {
			false }, itemsMandatory = { false })
	...
	@GraphQLInputParameters(names = { "firstName", "characters" }, types = { "String",
			"CharacterInput" }, mandatories = { true, true }, listDepths = { 0, true }, itemsMandatory = { false, true })
	...
	@GraphQLInputParameters(names = { "input" }, types = { "AllFieldCasesInput" }, mandatories = { false }, listDepths = {
			false }, itemsMandatory = { false })
	...
	@GraphQLInputParameters(names = { "human1", "human2", "droid1", "droid2" }, types = { "HumanInput", "HumanInput",
			"DroidInput", "DroidInput" }, mandatories = { false, false, false,
					false }, listDepths = { 0, false, false, false }, itemsMandatory = { false, false, false, false })
	...
	public com.graphql_java_generator.client.domain.allGraphQLCases.AllFieldCases withListOfListWithBindValues(
			String queryResponseDef, List<List<Double>> matrix, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	public com.graphql_java_generator.client.domain.allGraphQLCases.AllFieldCases withListOfList(
			String queryResponseDef, List<List<Double>> matrix, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@GraphQLNonScalar(fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public com.graphql_java_generator.client.domain.allGraphQLCases.AllFieldCases withListOfListWithBindValues(
			ObjectResponse objectResponse, List<List<Double>> matrix, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException {
	...
	@GraphQLNonScalar(fieldName = "withListOfList", graphQLTypeSimpleName = "AllFieldCases", javaClass = AllFieldCases.class)
	public com.graphql_java_generator.client.domain.allGraphQLCases.AllFieldCases withListOfList(
			ObjectResponse objectResponse, List<List<Double>> matrix, Object... paramsAndValues)
			throws GraphQLRequestExecutionException {
