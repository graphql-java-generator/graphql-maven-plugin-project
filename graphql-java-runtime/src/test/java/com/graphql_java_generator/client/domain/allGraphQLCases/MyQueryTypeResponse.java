 ...
 */
@GraphQLQuery(name = "MyQueryTypeResponse", type = RequestType.query)
public class MyQueryTypeResponse {
	...
	public String toString() {
		return "MyQueryType {" + "withoutParameters: " + withoutParameters + ", " + "withOneOptionalParam: "
				+ withOneOptionalParam + ", " + "withOneMandatoryParam: " + withOneMandatoryParam + ", " + "withEnum: "
				+ withEnum + ", " + "withList: " + withList + ", " + "allFieldCases: " + allFieldCases + ", "
				+ "error: " + error + ", " + "aBreak: " + aBreak + ", " + "directiveOnQuery: " + directiveOnQuery + ", "
				+ "directiveOnField: " + directiveOnField + ", " + "__schema: " + __schema + ", " + "__type: " + __type
				+ "}";
	}
	...
	public static enum Field implements GraphQLField {
		WithoutParameters("withoutParameters"), WithOneOptionalParam("withOneOptionalParam"), WithOneMandatoryParam(
				"withOneMandatoryParam"), WithEnum("withEnum"), WithList(
						"withList"), AllFieldCases("allFieldCases"), Error("error"), ABreak("aBreak"), DirectiveOnQuery(
								"directiveOnQuery"), DirectiveOnField(
										"directiveOnField"), __schema("__schema"), __type("__type");
