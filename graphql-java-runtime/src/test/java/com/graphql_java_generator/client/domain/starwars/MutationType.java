...
public class MutationType {
	...
	public Human createHumanWithBindValues(ObjectResponse objectResponse, String name, String homePlanet, Map<String, Object> parameters)
		...
		MutationTypeCreateHuman ret = configuration.getQueryExecutor().execute(objectResponse, parameters, MutationTypeCreateHuman.class);
	...
	public Human createHuman(ObjectResponse objectResponse, String name, String homePlanet, Object... paramsAndValues)
		...
		MutationTypeCreateHuman ret = configuration.getQueryExecutor().execute(objectResponse, bindVariableValues, MutationTypeCreateHuman.class);
	...
	public Character addFriendWithBindValues(ObjectResponse objectResponse, String idCharacter, String idNewFriend, Map<String, Object> parameters)
		...
		MutationTypeAddFriend ret = configuration.getQueryExecutor().execute(objectResponse, parameters, MutationTypeAddFriend.class);
	...
	public Character addFriend(ObjectResponse objectResponse, String idCharacter, String idNewFriend, Object... paramsAndValues)
		...
		MutationTypeAddFriend ret = configuration.getQueryExecutor().execute(objectResponse, bindVariableValues, MutationTypeAddFriend.class);
	...
	/**
	 * Get the {@link GraphQLRequest} for the addFriend mutation, created with the given Partial request.
	 * 
	 * @param partialRequest
	 * 				The Partial GraphQLRequest, as explained in the 
	 * 				<A HREF="https://graphql-maven-plugin-project.graphql-java-generator.com/client.html">plugin client documentation</A> 
