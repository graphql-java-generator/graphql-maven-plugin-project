...
public class MutationType extends MutationTypeExecutor
	...
	@GraphQLInputParameters(names = { "name", "homePlanet" }, types = { "String", "String" }, mandatories = { true,
			false }, listDepths = { 0, false }, itemsMandatory = { false, false })
	...
	@GraphQLInputParameters(names = { "idCharacter", "idNewFriend" }, types = { "String", "String" }, mandatories = {
			true, true }, listDepths = { 0, false }, itemsMandatory = { false, false })
	...
	public static enum Field implements GraphQLField {
		CreateHuman("createHuman"), AddFriend("addFriend"), __typename("__typename");
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "createHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.starwars.Human createHumanWithBindValues(String queryResponseDef,
			String name, String homePlanet, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "createHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.starwars.Human createHuman(String queryResponseDef, String name,
			String homePlanet, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "createHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.starwars.Human createHumanWithBindValues(
			ObjectResponse objectResponse, String name, String homePlanet, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException {
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "createHuman", graphQLTypeSimpleName = "Human", javaClass = Human.class)
	public com.graphql_java_generator.client.domain.starwars.Human createHuman(ObjectResponse objectResponse,
			String name, String homePlanet, Object... paramsAndValues) throws GraphQLRequestExecutionException {
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "addFriend", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public com.graphql_java_generator.client.domain.starwars.Character addFriendWithBindValues(String queryResponseDef,
			String idCharacter, String idNewFriend, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "addFriend", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public com.graphql_java_generator.client.domain.starwars.Character addFriend(String queryResponseDef,
			String idCharacter, String idNewFriend, Object... paramsAndValues)
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "addFriend", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public com.graphql_java_generator.client.domain.starwars.Character addFriendWithBindValues(
			ObjectResponse objectResponse, String idCharacter, String idNewFriend, Map<String, Object> parameters)
			throws GraphQLRequestExecutionException {
	...
	@Deprecated
	@GraphQLNonScalar(fieldName = "addFriend", graphQLTypeSimpleName = "Character", javaClass = Character.class)
	public com.graphql_java_generator.client.domain.starwars.Character addFriend(ObjectResponse objectResponse,
			String idCharacter, String idNewFriend, Object... paramsAndValues) throws GraphQLRequestExecutionException {
