...
/**
 * This class contains the methods that allows the execution of the subscriptions that are defined in the SubscriptionType of the GraphQL schema.<BR/>
...
public class SubscriptionTypeExecutor {
	 ...
	 *            An instance of SubscriptionCallback<Post>. Its {@link SubscriptionCallback#onMessage(Object)} 
	 *            will be called for each notification received from this subscription.
	 * @param boardName Parameter for the subscribeToNewPost field of SubscriptionType, as defined in the GraphQL schema
	 * @param parameters
	...
	public SubscriptionClient subscribeToNewPostWithBindValues(String queryResponseDef, 
		...
		ObjectResponse objectResponse = getSubscribeToNewPostResponseBuilder().withQueryResponseDef(queryResponseDef).build();
	...
	public SubscriptionClient subscribeToNewPost(String queryResponseDef, 
		...
		ObjectResponse objectResponse = getSubscribeToNewPostResponseBuilder().withQueryResponseDef(queryResponseDef).build();
		return subscribeToNewPostWithBindValues(objectResponse, subscriptionCallback, boardName, graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues));
	}
	...
	public SubscriptionClient subscribeToNewPostWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, "subscribeToNewPost", SubscriptionType.class, Post.class);
	}
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Post, as expected by the subscribeToNewPost subscription.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getSubscribeToNewPostResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "subscribeToNewPost", RequestType.subscription
			, InputParameter.newBindParameter("boardName","subscriptionTypeSubscribeToNewPostBoardName", InputParameterType.MANDATORY, "String", true, 0, false)
			);
	}
	...
	public SubscriptionClient __typenameWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, "__typename", SubscriptionType.class, String.class);
	}
