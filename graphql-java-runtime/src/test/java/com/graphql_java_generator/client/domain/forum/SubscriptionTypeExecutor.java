...
public class SubscriptionTypeExecutor {
	...
	public SubscriptionClient subscribeToNewPostWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback,
				"subscribeToNewPost", SubscriptionType.class, Post.class);
	}
	...
	public SubscriptionClient __typenameWithBindValues(ObjectResponse objectResponse,
		...
		return configuration.getQueryExecutor().execute(objectResponse, parameters, subscriptionCallback, "__typename",
				SubscriptionType.class, String.class);
	}
