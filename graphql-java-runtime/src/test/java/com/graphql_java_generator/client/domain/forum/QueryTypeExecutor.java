...
public class QueryTypeExecutor implements GraphQLQueryExecutor {
 ...
 @GraphQLScalar (fieldName = "nbBoards", graphQLTypeSimpleName = "Int", javaClass = Integer.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Integer, as expected by the nbBoards query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getNbBoardsResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "nbBoards", RequestType.query
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "topics", graphQLTypeSimpleName = "Topic", javaClass = Topic.class)
	...
	public com.graphql_java_generator.client.request.Builder getTopicsResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "topics", RequestType.query
			, InputParameter.newBindParameter("boardName","queryTypeTopicsBoardName", InputParameterType.MANDATORY, "String", true, 0, false)
			);
	}
 ...
 @GraphQLNonScalar (fieldName = "findTopics", graphQLTypeSimpleName = "Topic", javaClass = Topic.class)
	...
	/**
	 * Get the {@link com.graphql_java_generator.client.request.Builder} for the Topic, as expected by the findTopics query.
	 * 
	 * @return
	 * @throws GraphQLRequestPreparationException
	 */
	public com.graphql_java_generator.client.request.Builder getFindTopicsResponseBuilder() throws GraphQLRequestPreparationException {
		return new com.graphql_java_generator.client.request.Builder(GraphQLRequest.class, "findTopics", RequestType.query
			, InputParameter.newBindParameter("boardName","queryTypeFindTopicsBoardName", InputParameterType.MANDATORY, "String", true, 0, false)
			, InputParameter.newBindParameter("keyword","queryTypeFindTopicsKeyword", InputParameterType.OPTIONAL, "String", false, 1, true)
			);
	}
