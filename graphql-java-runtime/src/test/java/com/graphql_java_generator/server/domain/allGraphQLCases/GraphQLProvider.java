...
public class GraphQLProvider {
	...
	private RuntimeWiring buildWiring() {
		...
		return RuntimeWiring.newRuntimeWiring()
				...
				.scalar(GraphQLScalarTypeElse.getElseScalar()).scalar(graphql.Scalars.GraphQLLong)
				...
				.type(newTypeWiring("MyQueryType").dataFetcher("withOneMandatoryParamDefaultValue",
						graphQLDataFetchers.dataFetchersDelegateMyQueryTypeWithOneMandatoryParamDefaultValue()))
				.type(newTypeWiring("MyQueryType").dataFetcher("withTwoMandatoryParamDefaultVal",
						graphQLDataFetchers.dataFetchersDelegateMyQueryTypeWithTwoMandatoryParamDefaultVal()))
				...
				.type(newTypeWiring("MyQueryType").dataFetcher("unionTest",
						graphQLDataFetchers.dataFetchersDelegateMyQueryTypeUnionTest()))
				...
				.type(newTypeWiring("MyQueryType").dataFetcher("relay",
				...
				.type(newTypeWiring("TheSubscriptionType").dataFetcher("subscribeNewHumanForEpisode",
						graphQLDataFetchers.dataFetchersDelegateTheSubscriptionTypeSubscribeNewHumanForEpisode()))
				...
				//
				// Let's link the interface types to the concrete types
				.type("AnyCharacter", typeWiring -> typeWiring.typeResolver(getAnyCharacterResolver())).build();
	}
