...
public class AllFieldCases implements WithID {
	...
	@GraphQLScalar(fieldName = "aFloat", graphQLTypeName = "Float", list = false, javaClass = Double.class)
	Double aFloat;
	...
	@GraphQLScalar(fieldName = "dates", graphQLTypeName = "Date", list = true, javaClass = Date.class)
	List<Date> dates;
