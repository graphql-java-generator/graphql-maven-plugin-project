 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Topic>> friends(DataFetchingEnvironment environment, DataLoader<UUID, Topic> dataLoader,
 * 		Topic source) {
 ...
 */
@Component
public class BatchLoaderDelegateTopicImpl implements BatchLoaderDelegate<UUID, Topic> {
	 ...
	 */
	@Override
	public CompletionStage<List<Topic>> load(List<UUID> keys) {
