 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Board>> friends(DataFetchingEnvironment environment, DataLoader<UUID, Board> dataLoader,
 * 		Board source) {
 ...
 */
@Component
public class BatchLoaderDelegateBoardImpl implements BatchLoaderDelegate<UUID, Board> {
	 ...
	 */
	@Override
	public CompletionStage<List<Board>> load(List<UUID> keys) {
