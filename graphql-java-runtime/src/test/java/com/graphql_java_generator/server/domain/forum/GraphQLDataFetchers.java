...
public class GraphQLDataFetchers {
	...
	public DataFetcher<Topic> dataFetchersDelegateMutationTypeCreateTopic() {
		return dataFetchingEnvironment -> {
			TopicInput topic = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("topic"), false, TopicInput.class);
	...
	public DataFetcher<Post> dataFetchersDelegateMutationTypeCreatePost() {
		return dataFetchingEnvironment -> {
			PostInput post = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("post"), false, PostInput.class);
	...
	public DataFetcher<List<Post>> dataFetchersDelegateMutationTypeCreatePosts() {
		return dataFetchingEnvironment -> {
			List<PostInput> spam = graphqlUtils.getListInputObjects((List<Map<String, Object>>) dataFetchingEnvironment.getArgument("spam"), PostInput.class);
	...
	public DataFetcher<List<Post>> dataFetchersDelegateTopicPosts() {
		return dataFetchingEnvironment -> {
			UUID memberId = (dataFetchingEnvironment.getArgument("memberId") == null) ? null : UUID.fromString(dataFetchingEnvironment.getArgument("memberId"));
