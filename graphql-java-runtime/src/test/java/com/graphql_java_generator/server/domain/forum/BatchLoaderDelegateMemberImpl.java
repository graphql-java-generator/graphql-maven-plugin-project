 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Member>> friends(DataFetchingEnvironment environment, DataLoader<UUID, Member> dataLoader,
 * 		Member source) {
 ...
 */
@Component
public class BatchLoaderDelegateMemberImpl implements BatchLoaderDelegate<UUID, Member> {
	 ...
	 */
	@Override
	public CompletionStage<List<Member>> load(List<UUID> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateMember.batchLoader(keys));
	}
