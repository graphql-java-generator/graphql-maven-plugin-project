...
public class GraphQLDataFetchers {
	...
	public DataFetcher<Character> dataFetchersDelegateMyQueryTypeWithOneOptionalParam() {
		return dataFetchingEnvironment -> {
			CharacterInput character = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("character"), false, CharacterInput.class);
	...
	public DataFetcher<Character> dataFetchersDelegateMyQueryTypeWithOneMandatoryParamDefaultValue() {
		return dataFetchingEnvironment -> {
			...
			Character ret = null;
			try {
				ret = dataFetchersDelegateMyQueryType.withOneMandatoryParamDefaultValue(dataFetchingEnvironment, nbResultat);
			} catch (NoSuchElementException e) {
				// There was no items in the Optional
			}
	...
	public DataFetcher<Droid> dataFetchersDelegateMyQueryTypeWithTwoMandatoryParamDefaultVal() {
		return dataFetchingEnvironment -> {
			DroidInput theHero = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("theHero"), false, DroidInput.class);
	...
	public DataFetcher<AllFieldCases> dataFetchersDelegateMyQueryTypeAllFieldCases() {
		return dataFetchingEnvironment -> {
			AllFieldCasesInput input = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("input"), false, AllFieldCasesInput.class);
	...
	public DataFetcher<List<AnyCharacter>> dataFetchersDelegateMyQueryTypeUnionTest() {
		return dataFetchingEnvironment -> {
			HumanInput human1 = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("human1"), false, HumanInput.class);
			HumanInput human2 = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("human2"), false, HumanInput.class);
			DroidInput droid1 = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("droid1"), false, DroidInput.class);
			DroidInput droid2 = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("droid2"), false, DroidInput.class);
	...
	public DataFetcher<Human> dataFetchersDelegateAnotherMutationTypeCreateHuman() {
		return dataFetchingEnvironment -> {
			HumanInput human = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("human"), false, HumanInput.class);
	...
	public DataFetcher<AllFieldCasesWithoutIdSubtype> dataFetchersDelegateAllFieldCasesOneWithoutIdSubType() {
		return dataFetchingEnvironment -> {
			FieldParameterInput input = graphqlUtils.getInputObject((Map<String, Object>) dataFetchingEnvironment.getArgument("input"), false, FieldParameterInput.class);
  			AllFieldCases source = dataFetchingEnvironment.getSource();
