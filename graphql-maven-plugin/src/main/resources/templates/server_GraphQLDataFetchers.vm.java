...
#foreach ($argument in $dataFetcher.field.inputParameters)
			...
			Iterable<${dataFetcher.field.type.classSimpleName}> ret = ${dataFetcherDelegate.camelCaseName}.${dataFetcher.camelCaseName}(dataFetchingEnvironment#foreach($argument in $dataFetcher.field.inputParameters), ${argument.camelCaseName}#end);
			...
			return ret;
#else
			${dataFetcher.field.type.classSimpleName} ret = ${dataFetcherDelegate.camelCaseName}.${dataFetcher.camelCaseName}(dataFetchingEnvironment#foreach($argument in $dataFetcher.field.inputParameters), ${argument.camelCaseName}#end);
