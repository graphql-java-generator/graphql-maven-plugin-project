...
#foreach ($dataFetcher in $dataFetcherDelegate.dataFetchers)
	 ...
	 */
	public #if(${dataFetcher.field.list})List<#end${dataFetcher.field.type.classSimpleName}#if(${dataFetcher.field.list})>#end ${dataFetcher.camelCaseName}(#foreach($argument in $dataFetcher.field.inputParameters)${argument.type.classSimpleName} ${argument.camelCaseName}#if($foreach.hasNext), #end#end);
