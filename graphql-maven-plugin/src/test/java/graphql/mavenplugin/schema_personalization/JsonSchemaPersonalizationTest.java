...
class JsonSchemaPersonalizationTest {
	...
	void setUp() throws Exception {
		...
		jsonSchemaPersonalization.schemaPersonalizationFile = new File(new MavenTestHelper().getModulePathFile(),
				"src/test/resources/schema_personalization/complete.json");
		jsonSchemaPersonalization.log = new MavenLog(logger);

		jsonSchemaPersonalization.project = mock(MavenProject.class);
		when(jsonSchemaPersonalization.project.getBasedir()).thenReturn(new MavenTestHelper().getModulePathFile());
	}
