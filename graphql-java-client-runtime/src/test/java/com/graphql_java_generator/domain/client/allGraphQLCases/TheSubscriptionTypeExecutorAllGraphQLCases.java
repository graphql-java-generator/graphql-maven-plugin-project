...
public class TheSubscriptionTypeExecutorAllGraphQLCases implements GraphQLSubscriptionExecutor {
	...
	public com.graphql_java_generator.client.request.Builder getAllGraphQLCasesInputResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(graphQlClient, GraphQLRequest.class,
				...
				InputParameter.newBindParameter("AllGraphQLCases", "input",
						"theSubscriptionTypeAllGraphQLCasesInputInput", InputParameterType.MANDATORY,
						"AllFieldCasesInput", true, 0, false));
	}
	...
	public com.graphql_java_generator.client.request.Builder getAllGraphQLCasesParamResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(graphQlClient, GraphQLRequest.class,
				...
				InputParameter.newBindParameter("AllGraphQLCases", "name",
						"theSubscriptionTypeAllGraphQLCasesParamName", InputParameterType.MANDATORY, "String", true, 0,
						false),
				...
				InputParameter.newBindParameter("AllGraphQLCases", "integer",
						"theSubscriptionTypeAllGraphQLCasesParamInteger", InputParameterType.MANDATORY, "Int", true, 0,
						false),
				InputParameter.newBindParameter("AllGraphQLCases", "date",
						"theSubscriptionTypeAllGraphQLCasesParamDate", InputParameterType.MANDATORY, "Date", true, 0,
						false),
				InputParameter.newBindParameter("AllGraphQLCases", "dates",
						"theSubscriptionTypeAllGraphQLCasesParamDates", InputParameterType.MANDATORY, "Date", true, 1,
						false),
				InputParameter.newBindParameter("AllGraphQLCases", "matrix",
						"theSubscriptionTypeAllGraphQLCasesParamMatrix", InputParameterType.MANDATORY, "Float", true, 2,
						false),
