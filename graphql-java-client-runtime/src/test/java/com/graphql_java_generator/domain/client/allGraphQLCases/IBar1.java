...
@JsonSubTypes({ @Type(value = TBar1.class, name = "TBar1"), @Type(value = TBar12.class, name = "TBar12"), @Type(value = TBar2.class, name = "TBar2"), @Type(value = IBar2.class, name = "IBar2"), @Type(value = IBar3.class, name = "IBar3"), @Type(value = IBar12.class, name = "IBar12") })
@GraphQLInterfaceType("IBar1")
