...
@JsonSubTypes({ @Type(value = AllFieldCases.class, name = "AllFieldCases"),
		@Type(value = AllFieldCasesInterfaceType.class, name = "AllFieldCasesInterfaceType"),
		@Type(value = Human.class, name = "Human"), @Type(value = Droid.class, name = "Droid") })
