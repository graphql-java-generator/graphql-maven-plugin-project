...
public class SubscriptionExecutorForum implements GraphQLSubscriptionExecutor {

	/** Logger for this class */
	private static Logger logger = LoggerFactory.getLogger(SubscriptionExecutorForum.class);
	...
	public SubscriptionClient execWithBindValues(ObjectResponse objectResponse,
		...
		case "subscribeToNewPost":
			return objectResponse.exec(parametersLocal, (SubscriptionCallback<Post>) subscriptionCallback,
	...
	public SubscriptionClient subscribeToNewPostWithBindValues(ObjectResponse objectResponse,
		...
		// Given values for the BindVariables
		Map<String, Object> parametersLocal = (parameters != null) ? parameters : new HashMap<>();
		parametersLocal.put("subscriptionSubscribeToNewPostBoardName", boardName);

		return objectResponse.exec(parametersLocal, subscriptionCallback, Subscription.class, Post.class);
	}
