 ...
 */
@Component
public class QueryExecutorForum implements GraphQLQueryExecutor {

	/** Logger for this class */
	private static Logger logger = LoggerFactory.getLogger(QueryExecutorForum.class);
