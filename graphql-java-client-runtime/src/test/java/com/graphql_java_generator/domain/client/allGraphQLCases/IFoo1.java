...
@JsonSubTypes({ @Type(value = TFoo1.class, name = "TFoo1"), @Type(value = TFoo12.class, name = "TFoo12"), @Type(value = TFoo3.class, name = "TFoo3"), @Type(value = IFoo3.class, name = "IFoo3") })
