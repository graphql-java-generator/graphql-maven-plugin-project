...
public class MyQueryTypeExecutorAllGraphQLCases implements GraphQLQueryExecutor {
	...
	public com.graphql_java_generator.client.request.Builder getWithOneOptionalParamResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(graphQlClient, GraphQLRequest.class,
				...
				InputParameter.newBindParameter("AllGraphQLCases", "character",
						"myQueryTypeWithOneOptionalParamCharacter", InputParameterType.OPTIONAL, "CharacterInput",
						false, 0, false));
	}
	...
	public com.graphql_java_generator.client.request.Builder getWithOneMandatoryParamResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(graphQlClient, GraphQLRequest.class,
				...
				InputParameter.newBindParameter("AllGraphQLCases", "character",
						"myQueryTypeWithOneMandatoryParamCharacter", InputParameterType.MANDATORY, "CharacterInput",
						true, 0, false));
	}
	...
	public com.graphql_java_generator.client.request.Builder getWithTwoMandatoryParamDefaultValResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(graphQlClient, GraphQLRequest.class,
				...
				InputParameter.newBindParameter("AllGraphQLCases", "theHero",
						...
						true, 0, false),
				InputParameter.newBindParameter("AllGraphQLCases", "num",
						"myQueryTypeWithTwoMandatoryParamDefaultValNum", InputParameterType.OPTIONAL, "Int", false, 0,
						false));
	}
	...
	public com.graphql_java_generator.client.request.Builder getWithEnumResponseBuilder()
		...
		return new com.graphql_java_generator.client.request.Builder(graphQlClient, GraphQLRequest.class, "withEnum",
				RequestType.query, InputParameter.newBindParameter("AllGraphQLCases", "episode",
						"myQueryTypeWithEnumEpisode", InputParameterType.MANDATORY, "Episode", true, 0, false));
	}
