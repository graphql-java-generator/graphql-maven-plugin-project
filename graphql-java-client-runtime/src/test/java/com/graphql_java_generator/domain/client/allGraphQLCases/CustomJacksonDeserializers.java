...
public class CustomJacksonDeserializers {
	...
	public static class ListHuman extends AbstractCustomJacksonDeserializer<List<Human>> {
		...
		public ListHuman() {
			super(null, true, Human.class, null);
		}
	}
	...
	public static class ListEpisode extends AbstractCustomJacksonDeserializer<List<Episode>> {
		...
		public ListEpisode() {
			super(null, true, Episode.class, null);
		}
	}
	...
	public static class ListAnyCharacter extends AbstractCustomJacksonDeserializer<List<AnyCharacter>> {
		...
		public ListAnyCharacter() {
			super(null, true, AnyCharacter.class, null);
		}
	}
	...
	public static class Long extends AbstractCustomJacksonDeserializer<java.lang.Long> {
		...
		public Long() {
			super(null, false, java.lang.Long.class, graphql.scalars.ExtendedScalars.GraphQLLong);
		}
	}
	...
	public static class ListCharacter extends AbstractCustomJacksonDeserializer<List<Character>> {
		...
		public ListCharacter() {
			super(null, true, Character.class, null);
		}
	}
	...
	public static class ListAllFieldCasesWithoutIdSubtype
			extends AbstractCustomJacksonDeserializer<List<AllFieldCasesWithoutIdSubtype>> {
		private static final long serialVersionUID = 1L;

		public ListAllFieldCasesWithoutIdSubtype() {
			super(null, true, AllFieldCasesWithoutIdSubtype.class, null);
		}
	}
	...
	public static class ListEnumWithReservedJavaKeywordAsValues
			extends AbstractCustomJacksonDeserializer<List<EnumWithReservedJavaKeywordAsValues>> {
		private static final long serialVersionUID = 1L;

		public ListEnumWithReservedJavaKeywordAsValues() {
			super(null, true, EnumWithReservedJavaKeywordAsValues.class, null);
		}
	}
	...
	public static class ListTFoo1 extends AbstractCustomJacksonDeserializer<List<TFoo1>> {
		...
		public ListTFoo1() {
			super(null, true, TFoo1.class, null);
		}
	}
	...
	public static class ListAllFieldCasesWithIdSubtype
			extends AbstractCustomJacksonDeserializer<List<AllFieldCasesWithIdSubtype>> {
		private static final long serialVersionUID = 1L;

		public ListAllFieldCasesWithIdSubtype() {
			super(null, true, AllFieldCasesWithIdSubtype.class, null);
		}
	}
	...
	public static class ListIFoo1 extends AbstractCustomJacksonDeserializer<List<IFoo1>> {
		...
		public ListIFoo1() {
			super(null, true, IFoo1.class, null);
		}
	}
