...
public class TFoo12 implements IFoo1, IFoo2 {
	...
	public void setBar(IBar2 bar) {
		if (bar == null || bar instanceof TBar12) {
			...
			throw new IllegalArgumentException(
					"The given bar should be an instance of TBar12, but is an instance of " + bar.getClass().getName());
		}
	}
	...
	public String toString() {
		return "TFoo12 {" + "id: " + id + ", " + "bar: " + bar + ", " + "__typename: " + __typename + "}";
	}
