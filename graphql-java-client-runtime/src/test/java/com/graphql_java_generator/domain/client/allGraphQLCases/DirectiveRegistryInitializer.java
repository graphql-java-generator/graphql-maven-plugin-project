...
public class DirectiveRegistryInitializer {
	...
	public static DirectiveRegistry initDirectiveRegistry() {
		...
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "value", null, "String", true, 0, false));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "anotherValue", null, "String", false, 0, false));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "anArray", null, "String", false, 1, true));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "anObject", null, "CharacterInput", false, 0, false));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "anInt", null, "Int", false, 0, false));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "aFloat", null, "Float", false, 0, false));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "aBoolean", null, "Boolean", false, 0, false));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "anID", null, "ID", false, 0, false));
		directive.getArguments().add(
			InputParameter.newHardCodedParameter(
					"MySchema", "aCustomScalarDate", null, "Date", false, 0, false));
		directive.getDirectiveLocations().add(DirectiveLocation.QUERY);
		directive.getDirectiveLocations().add(DirectiveLocation.MUTATION);
		directive.getDirectiveLocations().add(DirectiveLocation.FIELD);
		directive.getDirectiveLocations().add(DirectiveLocation.FRAGMENT_DEFINITION);
