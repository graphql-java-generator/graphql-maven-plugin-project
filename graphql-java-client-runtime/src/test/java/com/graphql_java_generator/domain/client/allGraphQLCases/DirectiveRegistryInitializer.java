...
public class DirectiveRegistryInitializer {
	...
	public static void initDirectiveRegistry() {
		DirectiveRegistryImpl.registerDirectiveRegistry("MySchema", (directiveRegistry) -> {
			Directive directive;

			/////////////////////////////////////////////////////////////////////////////////////////////////////
			// Creating Directive skip
			/////////////////////////////////////////////////////////////////////////////////////////////////////
			directive = new Directive("MySchema");
			...
			directive.getArguments().add(
					InputParameter.newHardCodedParameter("MySchema", "anotherValue", null, "String", false, 0, false));
			directive.getArguments()
					.add(InputParameter.newHardCodedParameter("MySchema", "anArray", null, "String", false, 1, true));
			directive.getArguments().add(InputParameter.newHardCodedParameter("MySchema", "anObject", null,
			...
			directive.getArguments().add(
					InputParameter.newHardCodedParameter("MySchema", "aBoolean", null, "Boolean", false, 0, false));
			directive.getArguments()
					.add(InputParameter.newHardCodedParameter("MySchema", "anID", null, "ID", false, 0, false));
			directive.getArguments().add(InputParameter.newHardCodedParameter("MySchema", "aCustomScalarDate", null,
					"Date", false, 0, false));
			directive.getDirectiveLocations().add(DirectiveLocation.QUERY);
			directive.getDirectiveLocations().add(DirectiveLocation.MUTATION);
			directive.getDirectiveLocations().add(DirectiveLocation.FIELD);
