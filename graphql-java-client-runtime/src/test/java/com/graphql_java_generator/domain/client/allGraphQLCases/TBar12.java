 ...
 */
@GraphQLObjectType("TBar12")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class TBar12 implements IBar12, IBar1, IBar2 {
	...
	public String toString() {
		return "TBar12 {" + "id: " + id + ", " + "__typename: " + __typename + "}";
	}
	...
	public static class Builder {
		...
		public TBar12 build() {
			TBar12 _object = new TBar12();
			_object.setId(id);
			_object.set__typename("TBar12");
			return _object;
		}
	}
}
