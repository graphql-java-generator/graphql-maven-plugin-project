...
public class Foo140 implements I2Foo140, IFoo140 {
	...
	public void setBar(IBar140 bar) {
		if (bar == null || bar instanceof Bar140) {
			...
			throw new IllegalArgumentException(
					"The given bar should be an instance of Bar140, but is an instance of " + bar.getClass().getName());
		}
	}
	...
	public String toString() {
		return "Foo140 {" + "bar: " + bar + ", " + "__typename: " + __typename + "}";
	}
