...
public class MyQueryType {
	 ...
	 */
	@GraphQLNonScalar(fieldName = "connectionWithoutParameters", graphQLTypeSimpleName = "CharacterConnection", javaClass = CharacterConnection.class)
	CharacterConnection connectionWithoutParameters;

	@GraphQLNonScalar(fieldName = "connectionOnHuman", graphQLTypeSimpleName = "HumanConnection", javaClass = HumanConnection.class)
	HumanConnection connectionOnHuman;
	 ...
	 * addRelayConnections capability
	 */
	public void setConnectionWithoutParameters(CharacterConnection connectionWithoutParameters) {
	 ...
	 * addRelayConnections capability
	 */
	public CharacterConnection getConnectionWithoutParameters() {
		return connectionWithoutParameters;
	}

	public void setConnectionOnHuman(HumanConnection connectionOnHuman) {
		this.connectionOnHuman = connectionOnHuman;
	}

	public HumanConnection getConnectionOnHuman() {
	...
	public String toString() {
		return "MyQueryType {" + "withoutParameters: " + withoutParameters + ", " + "withOneOptionalParam: "
				...
				+ issue82Float + ", " + "issue82ID: " + issue82ID + ", " + "relay: " + relay + "}";
	}
	...
	public static class Builder {
		...
		private CharacterConnection connectionWithoutParameters;
		private HumanConnection connectionOnHuman;
		...
		public Builder withConnectionWithoutParameters(CharacterConnection connectionWithoutParameters) {
			this.connectionWithoutParameters = connectionWithoutParameters;
			return this;
		}

		public Builder withConnectionOnHuman(HumanConnection connectionOnHuman) {
			this.connectionOnHuman = connectionOnHuman;
			return this;
		}
