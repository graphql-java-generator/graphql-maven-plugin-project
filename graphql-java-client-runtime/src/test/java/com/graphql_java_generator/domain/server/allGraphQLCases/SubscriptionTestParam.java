...
public class SubscriptionTestParam {
	...
	public String toString() {
		return "SubscriptionTestParam {" + "errorOnSubscription: " + errorOnSubscription + ", " + "errorOnNext: "
				+ errorOnNext + ", " + "completeAfterFirstNotification: " + completeAfterFirstNotification + ", "
