...
/**
 * This class is to be removed, as soon as this use case (GraphQLRepository in non spring app) is confirmed to be
 * useless.<BR/>
 * Note: then, it's useless to keep
 * 
 * @author etienne-sf
 *
 */
...
class GraphQLRepositoryInvocationHandlerFirstTest extends AbstractGraphQLRepositoryInvocationHandlerTest {
	...
	// // Verification
	// assertTrue(e.getMessage().contains(
	// "Float and float parameter types are not allowed. Please note that the GraphQL Float type maps to the Double java
	// type."),
	// e.getMessage());
	// }
}
