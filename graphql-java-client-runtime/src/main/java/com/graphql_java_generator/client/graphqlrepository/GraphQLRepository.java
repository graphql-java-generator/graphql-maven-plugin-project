 ...
 * <LI>The {@link GraphQLRepository} must annotate each GraphQL repository interface</LI>
 * </DIR>
 ...
 * <LI>For queries or mutations, the return type of each method must be the POJO generated by the plugin, that maps the
 * GraphQL requests return type</LI>
 * <LI>For subscriptions, the return type of each method must be {@link SubscriptionClient}</LI>
 * </DIR>
 * </LI>
 * 
 ...
 * GraphQL variable.</LI>
 * <LI>Every method of this interface must throw the {@link GraphQLRequestExecutionException}</LI>
 * <LI>For queries or mutations, the return type of each method must be the POJO generated by the plugin for the GraphQL
 * query or mutation object</LI>
 * <LI>For subscriptions, the return type of each method must be the POJO generated by the plugin for the GraphQL
 * subscription object</LI>
 * </DIR>
 * </LI>
 * 
 * </DIR>
