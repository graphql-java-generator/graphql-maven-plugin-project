 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Topic>> friends(DataFetchingEnvironment environment, DataLoader<java.lang.Long, Topic> dataLoader,
 * 		Topic source) {
...
public class BatchLoaderDelegateTopicImpl implements BatchLoaderDelegateWithContext<java.lang.Long, org.forum.generated.Topic> {
	 ...
	 * @return the list of Topics corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<org.forum.generated.Topic>> load(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		// We use supplyAsync() of values here for maximum parallelism
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateTopic.batchLoader(keys, environment));
	}
