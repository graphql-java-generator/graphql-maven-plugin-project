...
public interface DataFetchersDelegateMember {
	 ...
	 */
	default public List<org.forum.generated.Member> batchLoader(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		List<org.forum.generated.Member> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null)
			throw new NullPointerException("Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateMember implementation. And unorderedReturnBatchLoader must return a list.");
	 ...
	 * @return
	 */
	default public List<org.forum.generated.Member> unorderedReturnBatchLoader(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
