 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Member>> friends(DataFetchingEnvironment environment, DataLoader<java.lang.Long, Member> dataLoader,
 * 		Member source) {
...
public class BatchLoaderDelegateMemberImpl implements BatchLoaderDelegateWithContext<java.lang.Long, org.forum.generated.Member> {
	 ...
	 * @return the list of Members corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<org.forum.generated.Member>> load(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		// We use supplyAsync() of values here for maximum parallelism
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateMember.batchLoader(keys, environment));
	}
