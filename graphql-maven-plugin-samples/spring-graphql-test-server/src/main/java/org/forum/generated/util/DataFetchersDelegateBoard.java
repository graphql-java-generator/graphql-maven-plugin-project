...
public interface DataFetchersDelegateBoard {
	...
	public List<org.forum.generated.Topic> topics(DataFetchingEnvironment dataFetchingEnvironment,
			org.forum.generated.Board origin, java.util.Date since);
	 ...
	 */
	default public List<org.forum.generated.Board> batchLoader(List<java.lang.Long> keys,
			BatchLoaderEnvironment environment) {
		List<org.forum.generated.Board> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null)
			throw new NullPointerException(
					"Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateBoard implementation. And unorderedReturnBatchLoader must return a list.");
	 ...
	 * @return
	 */
	default public List<org.forum.generated.Board> unorderedReturnBatchLoader(List<java.lang.Long> keys,
			BatchLoaderEnvironment environment) {
		return null;
	}
