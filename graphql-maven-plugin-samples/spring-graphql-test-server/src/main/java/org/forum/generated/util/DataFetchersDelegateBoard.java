...
public interface DataFetchersDelegateBoard {
	 ...
	 * <PRE>
	 * @Override
	 * public CompletableFuture<List<Character>> friends(DataFetchingEnvironment environment, DataLoader<Long, List<Topic>> dataLoader, Human origin) {
	 ...
	 *    of the <I>origin</I>, which is an instance of {ObjectType {name:Board, fields:{Field{name:id, type:ID!, params:[]},Field{name:name, type:String!, params:[]},Field{name:publiclyAvailable, type:Boolean, params:[]},Field{name:topics, type:[Topic]!, params:[since:Date]}}, comments ""}. It depends on your data modle, but it typically contains 
	 ...
	 */
	public CompletableFuture<List<org.forum.generated.Topic>> topics(
			DataFetchingEnvironment dataFetchingEnvironment, 
			DataLoader<java.lang.Long, org.forum.generated.Topic> dataLoader, 
			org.forum.generated.Board origin, 
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public List<org.forum.generated.Topic> topics(DataFetchingEnvironment dataFetchingEnvironment, org.forum.generated.Board origin, java.util.Date since);
	 ...
	 */
	default public List<org.forum.generated.Board> batchLoader(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		List<org.forum.generated.Board> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null)
			throw new NullPointerException("Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateBoard implementation. And unorderedReturnBatchLoader must return a list.");
	 ...
	 * @return
	 */
	default public List<org.forum.generated.Board> unorderedReturnBatchLoader(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
