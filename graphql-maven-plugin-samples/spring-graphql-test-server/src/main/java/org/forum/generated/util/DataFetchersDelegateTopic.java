...
public interface DataFetchersDelegateTopic {
	...
	/**
	 * This method loads the data for Topic.author. 
	 * <BR/>
	...
	public CompletableFuture<org.forum.generated.Member> author(
			...
			org.forum.generated.Topic origin);
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public org.forum.generated.Member author(DataFetchingEnvironment dataFetchingEnvironment, org.forum.generated.Topic origin);
	 ...
	 * <PRE>
	 * @Override
	 * public CompletableFuture<List<Character>> friends(DataFetchingEnvironment environment, DataLoader<Long, List<Post>> dataLoader, Human origin) {
	 *     List<java.lang.Long> friendIds = origin.getFriendIds();
	 *     DataLoader<java.lang.Long, CharacterImpl> dataLoader = environment.getDataLoader("Character");
	 *     return dataLoader.loadMany(friendIds);
	 * }
	 ...
	 *            "https://github.com/graphql-java/java-dataloader">https://github.com/graphql-java/java-dataloader</A>
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the posts attribute
	 *    of the <I>origin</I>, which is an instance of {ObjectType {name:Topic, fields:{Field{name:id, type:ID!, params:[]},Field{name:date, type:Date!, params:[]},Field{name:author, type:Member!, params:[]},Field{name:publiclyAvailable, type:Boolean, params:[]},Field{name:nbPosts, type:Int, params:[]},Field{name:title, type:String!, params:[]},Field{name:content, type:String, params:[]},Field{name:posts, type:[Post]!, params:[memberId:ID,memberName:String,since:Date!]},Field{name:boardId, type:ID, params:[]},Field{name:authorId, type:ID, params:[]}}, comments ""}. It depends on your data modle, but it typically contains 
	 *    the id to use in the query.
	 * @param memberId 
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public CompletableFuture<List<org.forum.generated.Post>> posts(
			DataFetchingEnvironment dataFetchingEnvironment, 
			DataLoader<java.lang.Long, org.forum.generated.Post> dataLoader, 
			org.forum.generated.Topic origin, 
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public List<org.forum.generated.Post> posts(DataFetchingEnvironment dataFetchingEnvironment, org.forum.generated.Topic origin, java.lang.Long memberId, java.lang.String memberName, java.util.Date since);
	 ...
	 */
	default public List<org.forum.generated.Topic> batchLoader(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		List<org.forum.generated.Topic> ret = unorderedReturnBatchLoader(keys, environment);
		if (ret == null)
			throw new NullPointerException("Either batchLoader or unorderedReturnBatchLoader must be overriden in DataFetchersDelegateTopic implementation. And unorderedReturnBatchLoader must return a list.");
	 ...
	 * @return
	 */
	default public List<org.forum.generated.Topic> unorderedReturnBatchLoader(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		return null;
	}
