 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Board>> friends(DataFetchingEnvironment environment, DataLoader<java.lang.Long, Board> dataLoader,
 * 		Board source) {
...
public class BatchLoaderDelegateBoardImpl implements BatchLoaderDelegateWithContext<java.lang.Long, org.forum.generated.Board> {
	 ...
	 */
	@Override
	public CompletionStage<List<org.forum.generated.Board>> load(List<java.lang.Long> keys, BatchLoaderEnvironment environment) {
		// We use supplyAsync() of values here for maximum parallelism
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateBoard.batchLoader(keys, environment));
	}
