...
import org.allGraphQLCases.demo.impl.PartialPreparedQueriesDeprecatedWay;
...
class PartialPreparedQueriesDeprecatedWayIT extends AbstractIT {

	@Override
	protected PartialQueries getQueries() {
		return ctx.getBean(PartialPreparedQueriesDeprecatedWay.class);
	}
