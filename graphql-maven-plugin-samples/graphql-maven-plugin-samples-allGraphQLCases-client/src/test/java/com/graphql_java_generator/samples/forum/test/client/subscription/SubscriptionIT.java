...
import org.forum.client.util.GraphQLRequestForum;
...
class SubscriptionIT {
	...
	@Autowired
	SubscriptionExecutorForum subscriptionType;

	@Autowired
	MutationExecutorForum mutationType;

	GraphQLRequestForum subscriptionRequest;
	GraphQLRequestForum createPostRequest;
