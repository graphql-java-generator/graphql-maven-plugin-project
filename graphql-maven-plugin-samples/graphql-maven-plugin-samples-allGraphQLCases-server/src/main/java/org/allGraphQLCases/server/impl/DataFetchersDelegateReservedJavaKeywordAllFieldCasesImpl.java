...
public class DataFetchersDelegateReservedJavaKeywordAllFieldCasesImpl
	...
	@Override
	public SIP_WithID_SIS _implements(DataFetchingEnvironment dataFetchingEnvironment,
			STP_ReservedJavaKeywordAllFieldCases_STS origin) {
		return generator.generateInstance(SIP_WithID_SIS.class);
	}
	...
	@Override
	public STP_Human_STS _int(DataFetchingEnvironment dataFetchingEnvironment,
			STP_ReservedJavaKeywordAllFieldCases_STS origin) {
	...
	@Override
	public SIP_WithID_SIS nonJavaKeywordField(DataFetchingEnvironment dataFetchingEnvironment,
			STP_ReservedJavaKeywordAllFieldCases_STS origin) {
		return generator.generateInstance(SIP_WithID_SIS.class);
	}
