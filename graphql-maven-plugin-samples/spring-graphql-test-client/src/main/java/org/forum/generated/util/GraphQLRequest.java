...
import org.forum.generated.util.CustomScalarRegistryInitializer;
import org.forum.generated.util.DirectiveRegistryInitializer;
import org.forum.generated.util.GraphQLRequest;
import org.forum.generated.util.MutationRootResponse;
import org.forum.generated.util.QueryRootResponse;
import org.forum.generated.util.SubscriptionRootResponse;
...
public class GraphQLRequest extends ObjectResponse {
	 ...
	 * params.put("skip", Boolean.FALSE);
	 * // This will set the value sinceValue to the sinceParam field parameter
	 * SubscriptionResponse response = request.exec(params);
	 * ...
	 * }
	 * </PRE>
	 * 
	...
	public <T> SubscriptionClient execSubscription(SubscriptionCallback<T> subscriptionCallback, 
			...
			throws GraphQLRequestExecutionException {
		return exec(parameters, subscriptionCallback, Subscription.class, messageType);
	}
	 ...
	 * ..
	 * // This will set the value sinceValue to the sinceParam field parameter
	 * SubscriptionResponse response = request.exec("heroParam", heroParamValue, "skip", Boolean.FALSE);
	 * ...
	 * }
	 * </PRE>
	 * 
	...
	public <T> SubscriptionClient execSubscription(SubscriptionCallback<T> subscriptionCallback,
		...
		return exec(graphqlClientUtils.generatesBindVariableValuesMap(paramsAndValues), 
				subscriptionCallback, Subscription.class, messageType);
	}
